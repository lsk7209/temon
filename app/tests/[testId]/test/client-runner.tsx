...
export default function ClientRunner({ apiTestId, routeTestId, questions }: Props) {
    ...
    const quizQuestions: QuizQuestion[] = useMemo(() => questions.map((q) => {
        let tags1: string[] = []
        let tags2: string[] = []
        try { tags1 = JSON.parse(q.choice1Tags || "[]") } catch { }
        try { tags2 = JSON.parse(q.choice2Tags || "[]") } catch { }
