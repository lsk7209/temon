...
export const metadata: Metadata = {
  title: "화장실 사용 습관 테스트 | 화장실 사용 패턴으로 보는 16유형 | 테몬",
  description:
    "화장실 사용 패턴, 정리 습관으로 16유형 성향을 분석합니다. 화장실 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "화장실 테스트, 화장실 습관, 사용 패턴, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/bathroom-habit",
  },
  openGraph: {
    title: "화장실 사용 습관 테스트 | 화장실 사용 패턴으로 보는 16유형",
    description: "화장실 사용 패턴, 정리 습관으로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/bathroom-habit",
  },
}
