...
export const metadata: Metadata = {
  title: "침대 정리 스타일 테스트 | 침대 정리 습관으로 보는 16유형 | 테몬",
  description:
    "침대 정리 습관, 베개 배치로 16유형 성향을 분석합니다. 침대 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "침대 테스트, 침대 정리, 베개 배치, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/bed-making",
  },
  openGraph: {
    title: "침대 정리 스타일 테스트 | 침대 정리 습관으로 보는 16유형",
    description: "침대 정리 습관, 베개 배치로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
