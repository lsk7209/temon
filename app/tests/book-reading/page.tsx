...
export const metadata: Metadata = {
  title: "책 읽는 습관 테스트 | 책 읽는 방식으로 보는 16유형 | 테몬",
  description:
    "책 읽는 방식, 습관으로 16유형 성향을 분석합니다. 책 한 권에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "책 테스트, 책 읽기, 읽는 습관, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/book-reading",
  },
  openGraph: {
    title: "책 읽는 습관 테스트 | 책 읽는 방식으로 보는 16유형",
    description: "책 읽는 방식, 습관으로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/book-reading",
  },
}
