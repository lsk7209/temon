...
export const metadata: Metadata = {
  title: "아침식사 스타일 테스트 | 아침식사로 보는 16유형 | 테몬",
  description:
    "아침식사 선택과 준비 방식으로 16유형 성향을 분석합니다. 아침 한 끼에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "아침식사 테스트, 브런치, 아침 루틴, 식습관, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/breakfast-style",
  },
  openGraph: {
    title: "아침식사 스타일 테스트 | 아침식사로 보는 16유형",
    description: "아침식사 선택과 준비 방식으로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/breakfast-style",
  },
}
