...
const questions = [
  {
    id: 1,
    q: "아침식사 준비 방식은?",
    a1: { text: "직접 요리, 계획적으로", tags: ["J"] },
    a2: { text: "외부 구매, 간편하게", tags: ["P"] },
  },
  {
    id: 2,
    q: "아침식사 시간은?",
  ...
  },
  {
    id: 4,
    q: "아침식사 양은?",
    a1: { text: "풍부하게, 든든하게", tags: ["E"] },
    a2: { text: "간단하게, 가볍게", tags: ["I"] },
  },
  {
    id: 5,
    q: "아침식사 분위기는?",
  ...
  },
  {
    id: 6,
    q: "아침식사 후 활동은?",
    a1: { text: "계획 세우기, 체계적으로", tags: ["J"] },
    a2: { text: "자연스럽게, 유연하게", tags: ["P"] },
  },
  {
    id: 7,
    q: "아침식사 메뉴 고르는 기준은?",
    a1: { text: "영양, 건강", tags: ["T"] },
    a2: { text: "맛, 감성", tags: ["F"] },
  },
  {
    id: 8,
  ...
  },
  {
    id: 9,
    q: "아침식사 메뉴는?",
    a1: { text: "다양하게, 새로운 것", tags: ["N"] },
    a2: { text: "익숙하게, 기본 메뉴", tags: ["S"] },
  },
  {
    id: 10,
    q: "아침식사 장소는?",
    a1: { text: "집에서, 편안하게", tags: ["I"] },
    a2: { text: "카페나 식당, 분위기 있게", tags: ["E"] },
  },
  {
    id: 11,
    q: "아침식사 후 느낌은?",
    a1: { text: "에너지 충전, 활기차게", tags: ["E"] },
