...
const questions = [
  ...
  },
  {
    id: 5,
    q: "굽기와 식감의 기준은?",
    a1: { text: "바삭도 일정해야 만족", tags: ["S"] },
    a2: { text: "한 입마다 다른 느낌도 재미", tags: ["N"] },
  },
  {
    id: 6,
    q: "막 구운 붕어빵을 받았다면?",
  ...
  },
  {
    id: 7,
    q: "같이 있는 사람과는?",
    a1: { text: "나눠 먹자고 먼저 제안", tags: ["E"] },
    a2: { text: "내 페이스로 조용히 먹음", tags: ["I"] },
  },
  {
    id: 8,
    q: "계산 순간 당신은?",
    a1: { text: "금액 정확히 나누자고 제안", tags: ["T"] },
    a2: { text: "오늘은 내가 쏜다고 말함", tags: ["F"] },
  },
  {
    id: 9,
    q: "선호하는 속재료에 가깝게는?",
    a1: { text: "전통 팥이 진리", tags: ["S"] },
    a2: { text: "치즈·고구마 같은 변형도 환영", tags: ["N"] },
  },
  {
    id: 10,
    q: "붕어빵을 사게 되는 계기?",
  ...
  },
  {
    id: 12,
    q: "다 먹고 난 뒤 당신은?",
    a1: { text: "다음엔 어느 가게 갈지 기록", tags: ["E", "J"] },
    a2: { text: "오늘의 작은 행복으로 남겨둠", tags: ["I", "P"] },
  },
]
