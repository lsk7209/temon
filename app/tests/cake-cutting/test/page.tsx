...
const questions = [
  {
    id: 1,
    q: "케이크 자르는 방식은?",
    a1: { text: "정확하게 균등하게, 체계적으로", tags: ["J"] },
    a2: { text: "대충 자르기, 자연스럽게", tags: ["P"] },
  },
  {
    id: 2,
    q: "조각 선택은?",
    a1: { text: "예쁜 조각, 장식 있는 것", tags: ["F"] },
    a2: { text: "큰 조각, 많이 먹는 것", tags: ["T"] },
  },
  {
    id: 3,
    q: "케이크 자르는 순서는?",
  ...
  },
  {
    id: 4,
    q: "케이크 장식은?",
    a1: { text: "장식 보존, 예쁘게", tags: ["F"] },
    a2: { text: "맛 중심, 효율적으로", tags: ["T"] },
  },
  {
    id: 5,
    q: "케이크 나눠주는 방식은?",
    a1: { text: "공평하게, 모두에게", tags: ["F"] },
    a2: { text: "그때그때, 자연스럽게", tags: ["T"] },
  },
  {
    id: 6,
    q: "케이크 먹는 순서는?",
  ...
  },
  {
    id: 8,
    q: "케이크 선택 기준은?",
    a1: { text: "예쁜 케이크, 장식", tags: ["S"] },
    a2: { text: "특별한 케이크, 의미", tags: ["N"] },
  },
  {
    id: 9,
    q: "케이크 자르는 계획은?",
