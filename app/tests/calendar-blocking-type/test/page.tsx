...
const questions: QuizQuestion[] = [
  { id: 1, q: "📆 캘린더 블로킹 성향 테스트에서 나는", a1: { text: "계획/기준을 먼저 세운다", tags: ["I", "J"] }, a2: { text: "실행하며 조정한다", tags: ["E", "P"] } },
...
export default function TestPage() {
  const quizLogic = useQuizLogic({ testId: "calendar-blocking-type", questions, resultPath: "/tests/calendar-blocking-type/test/result" })
