...
import { Clock3, Sparkles, Building2 } from "lucide-react"

export const metadata: Metadata = {
  title: "🧭 커리어 피벗 유형 테스트 | 테몬",
  description: "기회 판단과 리스크 감수 방식으로 보는 직무 전환 스타일. 12문항, 3분 완성.",
  alternates: { canonical: "/tests/career-pivot-type" },
  openGraph: {
    title: "🧭 커리어 피벗 유형 테스트",
    description: "기회 판단과 리스크 감수 방식으로 보는 직무 전환 스타일",
    type: "website",
    url: "https://temon.kr/tests/career-pivot-type",
  },
}
    ...
    <div className="min-h-screen bg-[#F7FAFC] dark:bg-gray-950">
      <main className="container max-w-4xl mx-auto px-4 py-10">
        <div className="text-center space-y-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">🧭 커리어 피벗 유형 테스트</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">기회 판단과 리스크 감수 방식으로 보는 직무 전환 스타일</p>
          ...
          <Button asChild size="lg" className="h-14 px-10 text-lg">
            <Link href="/tests/career-pivot-type/test"><Sparkles className="h-5 w-5 mr-2" /> 테스트 시작하기</Link>
          </Button>
        </div>
      </main>
    </div>
