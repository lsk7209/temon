...
const shortDescription = "치킨 주문 습관으로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "치킨 주문 스타일 테스트로 알아보는 나의 성격! 12개의 질문으로 16가지 유형 중 당신은 어떤 유형일까요? 재미있는 치킨 주문 스타일 테스트를 지금 바로 무료로 시작해보세요."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "chicken-style",
  title: "치킨 주문 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "치킨 테스트, 치킨 성향, 치킨 반반, 치킨 주문 스타일, 배달 음식 테스트, 치킨 MBTI, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("치킨 주문 스타일 테스트"),
]
...
export default function ChickenStyleIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="chicken-style-quiz-schema" data={schemas.quiz} />
      <JsonLd id="chicken-style-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="chicken-style-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Chicken Style Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Chicken Style Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="chicken-style" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="치킨 주문 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
