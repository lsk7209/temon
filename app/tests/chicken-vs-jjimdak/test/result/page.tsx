...
const chickenTypes = {
  ENFP: {
    label: "즉흥 조합형",
    summary: "찜닭과 치킨을 그때그때 조합하는 활발한 타입",
    description: [
      "찜닭과 치킨을 그때그때 조합하는 당신! 오늘은 찜닭, 내일은 치킨으로 다양하게 즐겨요.",
      "음식을 먹을 때도 분위기에 맞춰서 선택하고, 모두가 즐거워하는 메뉴를 골라요.",
      "찜닭도 좋고 치킨도 좋아서, 상황에 맞게 선택하는 유연한 스타일이에요.",
    ],
  ...
  INFP: {
    label: "감성 찜닭형",
    summary: "찜닭의 따뜻함으로 위로받는 감성형",
    description: [
      "찜닭을 선호하는 당신! 찜닭의 따뜻한 국물로 위로받고, 감성적으로 느껴요.",
      "찜닭을 먹을 때도 따뜻한 국물과 함께 먹으며, 그 따뜻함을 온전히 느끼는 것을 좋아해요.",
      "혼자 조용히 찜닭을 먹으며, 그 순간의 평온함을 즐겨요.",
    ],
    traits: ["찜닭 선호", "따뜻함 중시", "감성적 즐김"],
    picks: ["찜닭", "따뜻한 국물", "감성적인 메뉴"],
  ...
  ENFJ: {
    ...
    description: [
      "모두가 즐거워할 메뉴를 선택하는 당신! 찜닭과 치킨을 조합해서 모두가 만족할 수 있도록 해요.",
      "음식을 먹을 때도 분위기를 띄우고, 모두가 함께 즐길 수 있는 메뉴를 골라요.",
      "찜닭도 좋고 치킨도 좋아서, 상황에 맞게 선택하는 배려심 있는 스타일이에요.",
    ],
  ...
  INFJ: {
    ...
    description: [
      ...
      "찜닭의 따뜻함이나 치킨의 바삭함을 깊이 있게 느끼며, 그 순간을 소중히 여겨요.",
  ...
  ENTP: {
    label: "실험 조합형",
    summary: "찜닭과 치킨을 실험적으로 조합하는 탐구형",
    description: [
      "찜닭과 치킨을 실험적으로 조합하는 당신! 새로운 조합을 시도하고, 다양한 맛을 탐구해요.",
  ...
  INTP: {
    ...
    description: [
      ...
      "찜닭과 치킨의 장단점을 분석하고, 상황에 맞는 최적의 선택을 해요.",
  ...
  ENTJ: {
    ...
    description: [
      ...
      "찜닭과 치킨을 목적에 맞게 선택하며, 효율적으로 영양을 섭취해요.",
  ...
  INTJ: {
    ...
    description: [
      ...
      "찜닭과 치킨의 완벽한 조합을 찾아서, 최고의 맛을 만드는 것을 좋아해요.",
  ...
  ESFJ: {
    ...
    description: [
      ...
      "찜닭의 따뜻함과 치킨의 바삭함을 조합해서, 모두가 만족할 수 있도록 해요.",
  ...
  ISFJ: {
    label: "안정 찜닭형",
    summary: "안정적인 찜닭으로 루틴을 유지하는 수호자형",
    description: [
      "안정적인 찜닭을 선호하는 당신! 항상 같은 메뉴로 루틴을 유지해요.",
      "찜닭의 따뜻함으로 위로받고, 안정적인 느낌을 즐겨요.",
      "혼자 조용히 찜닭을 먹으며, 그 순간의 평온함을 느끼는 것을 소중히 여겨요.",
    ],
    traits: ["안정적 선택", "찜닭 선호", "루틴 유지"],
    picks: ["찜닭", "안정적인 메뉴", "따뜻한 음식"],
    tips: ["영양 균형", "다양한 시도", "상황에 맞게"],
    match: "ENTP, ENFP",
    emoji: "🧸",
  },
  ESFP: {
    label: "즉흥 치킨형",
    summary: "즉흥적으로 치킨으로 즐거움을 만드는 에너지형",
    description: [
      "즉흥적으로 치킨을 선택하는 당신! 치킨의 바삭함과 상쾌함을 좋아해요.",
      "음식을 먹을 때도 분위기를 띄우고, 모두가 즐거워하는 모습을 만들어요.",
      "사람들과 함께 있을 때는 치킨의 즐거움을 나누며, 모두가 즐거워하는 모습을 만들어요.",
    ],
    traits: ["즉흥적 선택", "치킨 선호", "즐거움 중시"],
    picks: ["치킨", "즐거운 메뉴", "바삭한 맛"],
    tips: ["영양 균형", "다양한 시도", "상황에 맞게"],
    match: "INTJ, INFJ",
    emoji: "🎉",
  },
  ISFP: {
    label: "조용한 찜닭형",
    summary: "조용히 찜닭을 즐기는 미니멀형",
    description: [
      "조용히 찜닭을 즐기는 당신! 찜닭의 따뜻함을 혼자 조용히 즐겨요.",
      "음식을 먹을 때도 조용히 즐기며, 그 순간의 감정을 느끼는 것을 소중히 여겨요.",
      "혼자 조용히 찜닭을 먹으며, 그 순간의 평온함을 느끼는 것을 좋아해요.",
    ],
    traits: ["조용한 즐김", "찜닭 선호", "감성 몰입"],
    picks: ["찜닭", "조용한 메뉴", "감성적인 음식"],
    tips: ["영양 균형", "다양한 시도", "상황에 맞게"],
    match: "ENTJ, ESTJ",
    emoji: "🌿",
  },
  ESTJ: {
    ...
    description: [
      ...
      "찜닭과 치킨을 효율적으로 선택하며, 목표를 달성하는 것을 좋아해요.",
  ...
  ISTJ: {
    label: "루틴 찜닭형",
    summary: "정해진 루틴으로 안정적인 찜닭을 즐기는 수호자형",
    description: [
      "정해진 루틴으로 안정적인 찜닭을 즐기는 당신! 항상 같은 메뉴로 루틴을 유지해요.",
      "찜닭의 따뜻함으로 위로받고, 안정적인 느낌을 즐겨요.",
      "혼자 조용히 찜닭을 먹으며, 그 순간의 평온함을 느끼는 것을 소중히 여겨요.",
    ],
  ...
  ESTP: {
    ...
    description: [
      ...
      "찜닭과 치킨을 그때그때 선택하며, 효율적으로 즐기는 것을 좋아해요.",
  ...
  ISTP: {
    ...
    description: [
      ...
      "찜닭과 치킨을 실용적으로 선택하며, 목적에 맞게 즐기는 것을 좋아해요.",
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-center space-y-4">
                <ShareButtons
                  ...
                  testPath="/tests/chicken-vs-jjimdak/test"
                  resultType={mbtiType}
                  resultId={loadedResult?.id || resultId}
                  title={`나는 🍗 ${character.label}(${mbtiType})! 너는 찜닭파야 치킨파야?`}
...
export default function ChickenVsJjimdakResult() {
  return (
