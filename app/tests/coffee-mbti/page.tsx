...
const faqs = [
  ...getDefaultQuizFAQs("커피 MBTI 테스트"),
  {
    ...
    answer:
      "MBTI 성격 유형 이론을 바탕으로 커피 취향과 성격의 연관성을 분석하여 제작되었습니다. 12개의 질문을 통해 당신의 성향을 파악합니다.",
  },
  {
    question: "커피를 좋아하지 않아도 테스트할 수 있나요?",
    answer:
      "네, 가능합니다. 테스트는 커피 취향을 통해 성격을 알아보는 것이지만, 커피를 자주 마시지 않으시더라도 일반적인 선호도를 바탕으로 답변하시면 됩니다.",
  },
];
      ...
      <article className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto">
            ...
            <LandingConversionSection quizTitle="Coffee MBTI" />

            <RelatedTestsSection testId="coffee-mbti" />
