...
const questions = [
  {
    id: 1,
    q: "레시피 수정 빈도는?",
    a1: { text: "항상 레시피를 수정한다", tags: ["P"] },
    a2: { text: "가끔 레시피를 수정한다", tags: ["J"] },
  },
  {
    id: 2,
    q: "레시피 수정 방식은?",
    a1: { text: "대폭 수정한다", tags: ["P"] },
    a2: { text: "소폭 수정한다", tags: ["J"] },
  },
  {
    id: 3,
    q: "레시피 수정 선택 기준은?",
  ...
  },
  {
    ...
    a2: { text: "혼자만 레시피를 수정한다", tags: ["I"] },
  },
  {
    id: 9,
    q: "레시피 수정 준비는?",
    a1: { text: "미리 준비", tags: ["J"] },
    a2: { text: "그때그때 레시피를 수정한다", tags: ["P"] },
  },
  {
    id: 10,
    q: "레시피 수정 경험 활용은?",
