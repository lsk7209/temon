...
const questions = [
  {
    id: 1,
    q: "요리 멀티태스킹 빈도는?",
    a1: { text: "항상 여러 일을 동시에 한다", tags: ["E"] },
    a2: { text: "가끔 여러 일을 동시에 한다", tags: ["I"] },
  },
  {
    id: 2,
    q: "요리 멀티태스킹 방식은?",
    a1: { text: "즉흥적으로 여러 일을 한다", tags: ["P"] },
    a2: { text: "계획적으로 여러 일을 한다", tags: ["J"] },
  },
  {
    id: 3,
    q: "요리 멀티태스킹 선택 기준은?",
  ...
  },
  {
    ...
    a2: { text: "혼자만 멀티태스킹", tags: ["I"] },
  },
  {
    id: 9,
    q: "요리 멀티태스킹 준비는?",
    a1: { text: "미리 준비", tags: ["J"] },
    a2: { text: "그때그때 멀티태스킹", tags: ["P"] },
  },
  {
    id: 10,
    q: "요리 멀티태스킹 경험 활용은?",
