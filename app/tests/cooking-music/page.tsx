  ...
  return (
    <>
      ...
      <main className="container max-w-4xl mx-auto px-4 py-16">
          ...
          <CardContent className="p-8 md:p-12 text-center space-y-8">
            ...
            <div className="pt-8">
              <Button asChild size="lg" className="bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white text-lg px-8 py-6">
                <Link href="/tests/cooking-music/test">테스트 시작하기</Link>
              </Button>
            </div>
            ...
            <div className="pt-8 text-left space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                요리할 때 음악 스타일과 음악을 선택하는 방식을 통해 당신의 성격 유형을 분석합니다. 
                요리할 때 음악 스타일은 외향성, 내향성, 감성, 논리성 등 다양한 성격 특성을 반영합니다.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="mt-12">
          <AutoGscLandingBoost testId="cooking-music" />
        ...
        <div className="mt-12">
          <RelatedTestsSection testId="cooking-music" />
        </div>
