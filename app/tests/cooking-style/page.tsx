...
export const metadata: Metadata = {
  title: "요리 스타일 테스트 | 요리로 보는 16유형 | 테몬",
  description:
    "요리하는 방식과 선호도로 16유형 성향을 분석합니다. 요리 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "요리 테스트, 요리 스타일, 요리법, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/cooking-style",
  },
  openGraph: {
    title: "요리 스타일 테스트 | 요리로 보는 16유형",
    description: "요리하는 방식과 선호도로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/cooking-style",
  },
}
