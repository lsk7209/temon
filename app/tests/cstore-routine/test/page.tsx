...
const questions = [
  {
    id: 1,
    q: "편의점에 들어가면 첫 동선은?",
    a1: { text: "목표 코너로 직행", tags: ["J"] },
    a2: { text: "한 바퀴 돌며 구경", tags: ["P"] },
  },
  {
    id: 2,
    q: "음료 선택 기준은?",
    a1: { text: "늘 마시는 고정 픽", tags: ["S"] },
    a2: { text: "신제품 라벨이 보이면 시도", tags: ["N"] },
  },
  {
    id: 3,
    q: "함께 온 친구가 추천하면?",
  ...
  },
  {
    id: 7,
    q: "신상 코너의 당신은?",
    a1: { text: "성분·원재료 꼼꼼 체크", tags: ["S"] },
    a2: { text: "컨셉·조합 상상하며 선택", tags: ["N"] },
  },
  {
    id: 8,
    q: "점원과의 소통 스타일은?",
    a1: { text: "필요 사항만 짧고 명확히", tags: ["I"] },
    a2: { text: "가볍게 대화하며 정보 수집", tags: ["E"] },
  },
  {
    id: 9,
    q: "핫도그 하나 남았을 때?",
  ...
  },
  {
    id: 10,
    q: "계산대 앞 유혹 상품은?",
    a1: { text: "미리 정한 리스트만 결제", tags: ["J"] },
    a2: { text: "순간 끌리면 소소하게 추가", tags: ["P"] },
  },
  {
    id: 11,
    q: "편의점 커피를 고를 때?",
