...
const shortDescription = "편의점 선택 습관으로 16유형 성향을 분석합니다. 12문항, 3분, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "편의점 선택 습관으로 16유형 성향을 분석합니다. 12문항, 3분, 결과 공유 이미지 자동 생성."
...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "편의점 테스트, 편의점 조합, 편의점 루틴, 야식 테스트, 간편식 테스트, 편의점 MBTI, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("편의점 조합 스타일 테스트"),
]
...
export default function CvsComboIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="cvs-combo-quiz-schema" data={schemas.quiz} />
      <JsonLd id="cvs-combo-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="cvs-combo-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Cvs Combo Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Cvs Combo Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="cvs-combo" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="편의점 조합 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
