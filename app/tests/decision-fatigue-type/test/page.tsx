...
const questions: QuizQuestion[] = [
  { id: 1, q: "🧠 결정 피로 관리 테스트에서 나는", a1: { text: "계획/기준을 먼저 세운다", tags: ["I", "J"] }, a2: { text: "실행하며 조정한다", tags: ["E", "P"] } },
...
export default function TestPage() {
  const quizLogic = useQuizLogic({ testId: "decision-fatigue-type", questions, resultPath: "/tests/decision-fatigue-type/test/result" })
