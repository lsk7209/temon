...
export const metadata: Metadata = {
  title: "음료 선택 스타일 테스트 | 음료 선택으로 보는 16유형 | 테몬",
  description:
    "음료 고르는 기준과 선호도로 16유형 성향을 분석합니다. 음료 한 잔에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "음료 테스트, 음료 취향, 선택, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/drink-preference",
  },
  openGraph: {
    title: "음료 선택 스타일 테스트 | 음료 선택으로 보는 16유형",
    description: "음료 고르는 기준과 선호도로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/drink-preference",
  },
}
