...
export const metadata: Metadata = {
  title: "저녁 운동 습관 테스트 | 16유형 분석 | 테몬",
  description:
    "저녁에 운동하는 습관으로 알아보는 나의 성격 유형. 저녁에 운동할지 고민될 때, 저녁 운동 후 배가 고플 때 등 구체적인 상황으로 분석합니다.",
  keywords:
    "저녁 운동, 운동 습관, 저녁 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/evening-exercise",
  },
  openGraph: {
    title: "저녁 운동 습관 테스트 | 16유형 분석",
    description: "저녁에 운동하는 습관으로 알아보는 나의 성격 유형. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/evening-exercise",
  },
}
