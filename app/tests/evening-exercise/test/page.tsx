...
const questions = [
  {
    id: 1,
    q: "저녁에 운동할지 고민될 때",
    a1: { text: "미리 정해둔 운동을 한다", tags: ["J", "S"] },
    a2: { text: "그때그때 선택한다", tags: ["P", "N"] },
  },
  {
    id: 2,
    q: "저녁 운동 후 배가 고플 때",
    a1: { text: "정해진 식사를 한다", tags: ["J", "S"] },
    a2: { text: "그때그때 먹는다", tags: ["P", "N"] },
  },
  {
    id: 3,
    q: "저녁에 운동을 할 때",
    a1: { text: "정해진 루틴대로 한다", tags: ["S", "J"] },
    a2: { text: "자유롭게 한다", tags: ["N", "P"] },
  },
  {
    id: 4,
    q: "저녁에 운동을 하는 장소",
    a1: { text: "집에서 혼자 한다", tags: ["I", "S"] },
    a2: { text: "밖에서 사람들과 한다", tags: ["E", "N"] },
  },
  {
    id: 5,
    q: "저녁에 운동을 하는 시간",
  ...
  },
  {
    id: 7,
    q: "저녁에 운동이 힘들 때",
    a1: { text: "그냥 한다", tags: ["S", "T"] },
    a2: { text: "다른 운동을 찾는다", tags: ["N", "F"] },
  },
  {
    id: 8,
    q: "새로운 저녁 운동을 시도할 때",
...
export default function EveningExerciseTest() {
  ...
  useEffect(() => {
    trackTestStart("evening-exercise")
  }, [])
  ...
  const handleChoiceSelect = async (tags: string[]) => {
    ...
    trackTestProgress("evening-exercise", currentQuestion + 1, questions.length)
    ...
    if (currentQuestion < questions.length - 1) {
      ...
      try {
        ...
        router.push(`/tests/evening-exercise/test/result?type=${result}&id=${resultId}`)
      } catch (error) {
        console.error("결과 저장 실패:", error)
        router.push(`/tests/evening-exercise/test/result?type=${result}`)
      }
    }
  }
