...
const shortDescription = "저녁에 하루를 돌아보는 방식으로 알아보는 나의 성격 유형. 저녁에 하루를 돌아볼 때, 저녁에 내일 계획을 세울 때 등 구체적인 상황으로 분..."
// Full description for Google/AI
const fullDescription = "저녁에 하루를 돌아보는 방식으로 알아보는 나의 성격 유형. 저녁에 하루를 돌아볼 때, 저녁에 내일 계획을 세울 때 등 구체적인 상황으로 분석합니다."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "evening-reflection",
  title: "저녁 하루 돌아보기 테스트",
  shortDescription,
  fullDescription,
  keywords: "저녁 성찰, 하루 돌아보기, 저녁 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("저녁 하루 돌아보기 테스트"),
]
...
export default function EveningReflectionIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="evening-reflection-quiz-schema" data={schemas.quiz} />
      <JsonLd id="evening-reflection-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="evening-reflection-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <LandingConversionSection quizTitle="Evening Reflection Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="evening-reflection" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="저녁 하루 돌아보기 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
