...
export const metadata: Metadata = {
  title: "잠들기 전 준비 테스트 | 16유형 분석 | 테몬",
  description:
    "잠들기 전 준비하는 방식으로 알아보는 나의 성격 유형. 잠들기 전 준비를 할 때, 잠들기 전 루틴을 할 때 등 구체적인 상황으로 분석합니다.",
  keywords:
    "잠들기 전 준비, 수면 루틴, 저녁 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/evening-sleep-prep",
  },
  openGraph: {
    title: "잠들기 전 준비 테스트 | 16유형 분석",
    description: "잠들기 전 준비하는 방식으로 알아보는 나의 성격 유형. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/evening-sleep-prep",
  },
}
