...
export const metadata: Metadata = {
  title: "저녁 약속 대하는 방식 테스트 | 16유형 분석 | 테몬",
  description:
    "저녁 약속을 대하는 방식으로 알아보는 나의 성격 유형. 저녁 약속이 생겼을 때, 저녁 약속을 취소해야 할 때 등 구체적인 상황으로 분석합니다.",
  keywords:
    "저녁 약속, 사회성, 저녁 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/evening-social",
  },
  openGraph: {
    title: "저녁 약속 대하는 방식 테스트 | 16유형 분석",
    description: "저녁 약속을 대하는 방식으로 알아보는 나의 성격 유형. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/evening-social",
  },
}
