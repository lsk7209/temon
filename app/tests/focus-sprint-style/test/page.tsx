...
const questions: QuizQuestion[] = [
  { id: 1, q: "⚡ 포커스 스프린트 운영 테스트에서 나는", a1: { text: "계획/기준을 먼저 세운다", tags: ["I", "J"] }, a2: { text: "실행하며 조정한다", tags: ["E", "P"] } },
...
export default function TestPage() {
  const quizLogic = useQuizLogic({ testId: "focus-sprint-style", questions, resultPath: "/tests/focus-sprint-style/test/result" })
