...
const questions = [
  {
    id: 1,
    q: "알레르기 음식 대처는?",
    a1: { text: "철저히 피하기, 안전 우선", tags: ["J"] },
    a2: { text: "주의하며 먹기, 유연하게", tags: ["P"] },
  },
  {
    id: 2,
    q: "알레르기 확인 방식은?",
    a1: { text: "계획적 확인, 미리 체크", tags: ["J"] },
    a2: { text: "즉흥적 확인, 그때그때", tags: ["P"] },
  },
  {
    id: 3,
    q: "알레르기 대처 이유는?",
    a1: { text: "감성, 건강", tags: ["F"] },
