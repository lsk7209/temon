...
const shortDescription = "음식 브랜드에 대한 충성도와 선택 기준으로 알아보는 나의 성격 유형 테스트"
// Full description for Google/AI
const fullDescription = "브랜드 선호도 테스트로 알아보는 나의 성격! 12개의 질문으로 16가지 유형 중 당신은 어떤 유형일까요? 재미있는 브랜드 선호도 테스트를 지금 바로 무료로 시작해보세요."
...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "브랜드 선호도 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  canonical: "/tests/food-brand",
  questionCount: 12,
  duration: "PT3M",
})

const faqs = [
  ...getTopicQuizFAQs("브랜드 선호도 테스트"),
]
...
export default function FoodBrandPage() {
  ...
  return (
    <>
      ...
      <JsonLd id="food-brand-quiz-schema" data={schemas.quiz} />
      <JsonLd id="food-brand-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="food-brand-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-16">
          ...
          <CardContent className="p-8 md:p-12 text-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                음식 브랜드에 대한 충성도와 선택 기준으로 알아보는 나의 성격 유형
              </p>
            </div>
            ...
            <div className="pt-8">
              <Button asChild size="lg" className="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 hover:from-blue-600 hover:via-indigo-600 hover:to-purple-600 text-white text-lg px-8 py-6">
                <Link href="/tests/food-brand/test">테스트 시작하기</Link>
              </Button>
            </div>
            ...
            <div className="pt-8 text-left space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                항상 사던 브랜드가 품절되었을 때, 새로운 브랜드가 더 저렴할 때, 브랜드 이미지와 품질 중 선택할 때의 반응을 통해 당신의 성격 유형을 분석합니다. 
                브랜드 충성도, 가격 민감도, 품질 추구도 등 다양한 성격 특성을 반영합니다.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Food Brand Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Food Brand Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="food-brand" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="브랜드 선호도 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
