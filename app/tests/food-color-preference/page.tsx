  ...
  return (
    <>
      ...
      <main className="container max-w-4xl mx-auto px-4 py-16">
        <Card className="border-0 shadow-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur">
          <CardContent className="p-8 md:p-12 text-center space-y-8">
            <div className="flex justify-center">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-pink-400 via-purple-400 to-blue-400 flex items-center justify-center shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                음식 색상을 좋아하는 정도와 방식으로 알아보는 나의 성격 유형
              </p>
            </div>
            ...
            <div className="pt-8">
              <Button asChild size="lg" className="bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 hover:from-pink-600 hover:via-purple-600 hover:to-blue-600 text-white text-lg px-8 py-6">
                <Link href="/tests/food-color-preference/test">테스트 시작하기</Link>
              </Button>
            </div>
            ...
            <div className="pt-8 text-left space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                음식 색상을 좋아하는 정도와 색상을 선택하는 방식, 색상을 즐기는 패턴을 통해 당신의 성격 유형을 분석합니다. 
                음식 색상에 대한 선호도는 미적 감각, 감성, 감각 추구, 논리적 선택 등 다양한 성격 특성을 반영합니다.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="mt-12">
          <AutoGscLandingBoost testId="food-color-preference" />
        ...
        <div className="mt-12">
          <RelatedTestsSection testId="food-color-preference" />
        </div>
