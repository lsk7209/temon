...
const questions = [
  {
    id: 1,
    q: "음식 찍어 먹기 빈도는?",
    a1: { text: "항상 찍어서 먹기", tags: ["E"] },
    a2: { text: "가끔 찍어서 먹기", tags: ["I"] },
  },
  {
    id: 2,
    q: "음식 찍어 먹기 방식은?",
    a1: { text: "아주 많이 찍어 먹기", tags: ["N"] },
    a2: { text: "적당히 찍어 먹기", tags: ["S"] },
  },
  {
    id: 3,
    q: "음식 찍어 먹기 선택은?",
    a1: { text: "즉흥적으로 찍기", tags: ["P"] },
    a2: { text: "계획적으로 찍기", tags: ["J"] },
  },
  {
    id: 4,
    q: "음식 찍어 먹기 이유는?",
  ...
  },
  {
    id: 5,
    q: "음식 찍어 먹기 속도는?",
    a1: { text: "빠르게 찍기", tags: ["E"] },
    a2: { text: "천천히 찍기", tags: ["I"] },
  },
  {
    id: 6,
    q: "음식 찍어 먹기 대처는?",
    a1: { text: "즉시 찍기", tags: ["P"] },
...
export default function FoodDippingTest() {
  ...
  const { saveResult, isSaving } = useTestResult({
    ...
    onSuccess: (resultId, resultType) => {
      router.push(`/tests/food-dipping/test/result?type=${resultType}&id=${resultId}`)
    },
    onError: (error, resultType) => {
      console.error("결과 저장 실패:", error)
      router.push(`/tests/food-dipping/test/result?type=${resultType}`)
    },
  })
  ...
  useEffect(() => {
    trackTestStart("food-dipping")
  }, [])

  useEffect(() => {
    if (currentQuestion > 0) {
      trackTestProgress("food-dipping", currentQuestion + 1, questions.length)
    }
  }, [currentQuestion, questions.length])
        ...
        <Card className="border-0 shadow-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur">
          <CardContent className="p-8">
            <div className="text-center mb-8">
              <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-br from-cyan-400 via-blue-400 to-indigo-400 flex items-center justify-center shadow-lg">
              ...
              <button
                ...
                className={`w-full p-6 text-left rounded-2xl border-2 transition-all duration-300 transform hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 ${
                  selectedChoice === currentQ.a1.tags.join(",")
                    ? "border-cyan-500 bg-gradient-to-r from-cyan-50 via-blue-50 to-indigo-50 dark:from-cyan-950 dark:via-blue-950 dark:to-indigo-950 shadow-lg"
