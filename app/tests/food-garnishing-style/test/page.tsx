...
const questions = [
  {
    id: 1,
    q: "음식 장식 선택 빈도는?",
    a1: { text: "항상 장식 선택", tags: ["E"] },
    a2: { text: "가끔 장식 선택", tags: ["I"] },
  },
  {
    id: 2,
    q: "음식 장식 강도 선호는?",
    a1: { text: "아주 화려한 장식 선호", tags: ["N"] },
    a2: { text: "적당한 장식 선호", tags: ["S"] },
  },
  {
    id: 3,
    q: "음식 장식 선택 방식은?",
  ...
  },
  {
    id: 5,
    q: "음식 장식 속도는?",
    a1: { text: "빠르게 장식", tags: ["E"] },
    a2: { text: "천천히 장식", tags: ["I"] },
  },
  {
    id: 6,
    q: "음식 장식 대처 방식은?",
    a1: { text: "즉시 장식", tags: ["P"] },
...
export default function FoodGarnishingStyleTest() {
  ...
  const { saveResult, isSaving } = useTestResult({
    ...
    onSuccess: (resultId, resultType) => {
      router.push(`/tests/food-garnishing-style/test/result?type=${resultType}&id=${resultId}`)
    },
    onError: (error, resultType) => {
      console.error("결과 저장 실패:", error)
      router.push(`/tests/food-garnishing-style/test/result?type=${resultType}`)
    },
  })
  ...
  useEffect(() => {
    trackTestStart("food-garnishing-style")
  }, [])

  useEffect(() => {
    if (currentQuestion > 0) {
      trackTestProgress("food-garnishing-style", currentQuestion + 1, questions.length)
    }
  }, [currentQuestion, questions.length])
