...
const shortDescription = "음식 꾸미기와 장식 선호로 16유형 성향을 분석합니다. 장식 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "음식 꾸미기와 장식 선호로 16유형 성향을 분석합니다. 장식 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "food-garnishing",
  title: "음식 장식 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "음식 장식 테스트, 플레이팅, 음식 꾸미기, 미식, 성향 테스트, 심리테스트, 무료 테스트",
...
export default function FoodGarnishingIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="food-garnishing-quiz-schema" data={schemas.quiz} />
      <JsonLd id="food-garnishing-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="food-garnishing-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Food Garnishing Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Food Garnishing Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="food-garnishing" title="Next Quizzes Search Visitors Usually Click" />
        </div>
