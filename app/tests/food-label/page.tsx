...
const shortDescription = "식품 라벨 읽는 습관으로 16유형 성향을 분석합니다. 라벨 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "식품 라벨 읽는 습관으로 16유형 성향을 분석합니다. 라벨 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "food-label",
  title: "식품 라벨 확인 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "식품 라벨 테스트, 라벨 확인, 건강, 정보, 성향 테스트, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("식품 라벨 확인 스타일 테스트"),
]
...
export default function FoodLabelIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="food-label-quiz-schema" data={schemas.quiz} />
      <JsonLd id="food-label-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="food-label-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Food Label Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Food Label Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="food-label" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="식품 라벨 확인 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
