...
const questions = [
  {
    id: 1,
    q: "음식 층별 먹기 빈도는?",
    a1: { text: "항상 층별로 먹기", tags: ["E"] },
    a2: { text: "가끔 층별로 먹기", tags: ["I"] },
  },
  {
    id: 2,
    q: "음식 층별 먹기 방식은?",
    a1: { text: "완전히 층별로 먹기", tags: ["N"] },
    a2: { text: "적당히 층별로 먹기", tags: ["S"] },
  },
  {
    id: 3,
    q: "음식 층별 먹기 선택은?",
    a1: { text: "즉흥적으로 층별 먹기", tags: ["P"] },
    a2: { text: "계획적으로 층별 먹기", tags: ["J"] },
  },
  {
    id: 4,
    q: "음식 층별 먹기 이유는?",
  ...
  },
  {
    id: 5,
    q: "음식 층별 먹기 속도는?",
    a1: { text: "빠르게 층별 먹기", tags: ["E"] },
    a2: { text: "천천히 층별 먹기", tags: ["I"] },
  },
  {
    id: 6,
    q: "음식 층별 먹기 대처는?",
    a1: { text: "즉시 층별 먹기", tags: ["P"] },
...
export default function FoodLayeringTest() {
  ...
  const { saveResult, isSaving } = useTestResult({
    ...
    onSuccess: (resultId, resultType) => {
      router.push(`/tests/food-layering/test/result?type=${resultType}&id=${resultId}`)
    },
    onError: (error, resultType) => {
      console.error("결과 저장 실패:", error)
      router.push(`/tests/food-layering/test/result?type=${resultType}`)
    },
  })
  ...
  useEffect(() => {
    trackTestStart("food-layering")
  }, [])

  useEffect(() => {
    if (currentQuestion > 0) {
      trackTestProgress("food-layering", currentQuestion + 1, questions.length)
    }
  }, [currentQuestion, questions.length])
