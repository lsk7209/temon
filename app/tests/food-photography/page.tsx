...
const shortDescription = "음식 사진 찍는 방식으로 16유형 성향을 분석합니다. 사진 한 장에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "음식 사진 찍는 방식으로 16유형 성향을 분석합니다. 사진 한 장에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "food-photography",
  title: "음식 사진 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "음식 테스트, 사진 테스트, 촬영 스타일, 성향 테스트, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("음식 사진 스타일 테스트"),
]
...
export default function FoodPhotographyIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="food-photography-quiz-schema" data={schemas.quiz} />
      <JsonLd id="food-photography-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="food-photography-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Food Photography Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Food Photography Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="food-photography" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="음식 사진 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
