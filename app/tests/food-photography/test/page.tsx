...
const questions = [
  {
    id: 1,
    q: "촬영 방식은?",
    a1: { text: "계획적으로, 구도 고민", tags: ["J"] },
    a2: { text: "즉흥적으로, 자연스럽게", tags: ["P"] },
  },
  {
    id: 2,
    q: "구도 선택은?",
    a1: { text: "정확히, 규칙대로", tags: ["S"] },
    a2: { text: "감각적으로, 창의적으로", tags: ["N"] },
  },
  {
    id: 3,
    q: "촬영 이유는?",
    a1: { text: "감성, 예쁘게", tags: ["F"] },
    a2: { text: "기록, 정보", tags: ["T"] },
  },
  {
    id: 4,
    q: "공유 태도는?",
    a1: { text: "적극적으로 올리기", tags: ["E"] },
    a2: { text: "조용히 보관", tags: ["I"] },
  },
  {
    id: 5,
    q: "편집 스타일은?",
    a1: { text: "원본, 자연스럽게", tags: ["S"] },
    a2: { text: "편집, 창의적으로", tags: ["N"] },
  },
  {
    id: 6,
    q: "촬영 시점은?",
    a1: { text: "먹기 전, 바로", tags: ["J"] },
    a2: { text: "생각날 때", tags: ["P"] },
  },
  {
    id: 7,
    q: "촬영 후 느낌은?",
  ...
  },
  {
    id: 9,
    q: "촬영 장수는?",
    a1: { text: "정해진 수, 몇 장만", tags: ["J"] },
    a2: { text: "많이, 여러 각도", tags: ["P"] },
  },
  {
    id: 10,
    q: "촬영 스타일은?",
    a1: { text: "전통적, 클래식", tags: ["S"] },
    a2: { text: "실험적, 트렌디", tags: ["N"] },
  },
  {
    id: 11,
    q: "촬영 동기는?",
