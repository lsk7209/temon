...
const questions = [
  {
    id: 1,
    q: "접시 배치 선택 빈도는?",
    a1: { text: "항상 신중하게 배치", tags: ["E"] },
    a2: { text: "가끔 신중하게 배치", tags: ["I"] },
  },
  {
    id: 2,
    q: "접시 배치 강도 선호는?",
    a1: { text: "아주 정교한 배치 선호", tags: ["N"] },
    a2: { text: "적당한 배치 선호", tags: ["S"] },
  },
  {
    id: 3,
    q: "접시 배치 선택 방식은?",
    a1: { text: "즉흥적으로 배치", tags: ["P"] },
    a2: { text: "계획적으로 배치", tags: ["J"] },
  },
  {
    id: 4,
    q: "접시 배치 선택 이유는?",
  ...
  },
  {
    id: 5,
    q: "접시 배치 속도는?",
    a1: { text: "빠르게 배치", tags: ["E"] },
    a2: { text: "천천히 배치", tags: ["I"] },
  },
  {
    id: 6,
    q: "접시 배치 대처 방식은?",
    a1: { text: "즉시 배치", tags: ["P"] },
