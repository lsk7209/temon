...
const questions = [
  {
    id: 1,
    q: "리뷰 작성 빈도는?",
    a1: { text: "자주 작성, 적극적으로", tags: ["E"] },
    a2: { text: "가끔 작성, 신중하게", tags: ["I"] },
  },
  {
    id: 2,
    q: "리뷰 길이는?",
    a1: { text: "자세히, 상세하게", tags: ["J"] },
    a2: { text: "간단히, 핵심만", tags: ["P"] },
  },
  {
    id: 3,
    q: "리뷰 내용은?",
    a1: { text: "객관적, 사실 중심", tags: ["T"] },
    a2: { text: "주관적, 감성 중심", tags: ["F"] },
  },
  {
    id: 4,
    q: "리뷰 작성 시간은?",
    a1: { text: "즉시 작성, 바로", tags: ["E"] },
    a2: { text: "나중에 작성, 신중하게", tags: ["I"] },
  },
  {
    id: 5,
    q: "리뷰 공유는?",
    a1: { text: "적극적으로 공유", tags: ["E"] },
    a2: { text: "조용히, 혼자만", tags: ["I"] },
  },
  {
    id: 6,
    q: "리뷰 기준은?",
    a1: { text: "논리적, 객관적", tags: ["T"] },
    a2: { text: "감성적, 주관적", tags: ["F"] },
  },
  {
    id: 7,
    q: "리뷰 스타일은?",
  ...
  },
  {
    id: 10,
    q: "리뷰 이유는?",
    a1: { text: "도움, 실용", tags: ["T"] },
    a2: { text: "공유, 감성", tags: ["F"] },
  },
  {
    id: 11,
    q: "리뷰 선호는?",
    a1: { text: "전통 방식, 기본", tags: ["S"] },
    a2: { text: "새로운 방식, 혁신", tags: ["N"] },
  },
  {
    id: 12,
    q: "리뷰 기준은?",
    a1: { text: "실용성, 효율성", tags: ["T"] },
    a2: { text: "감성, 의미", tags: ["F"] },
  },
]
...
export default function FoodReviewTest() {
  ...
  const { saveResult, isSaving } = useTestResult({
    ...
    onSuccess: (resultId, resultType) => {
      router.push(`/tests/food-review/test/result?type=${resultType}&id=${resultId}`)
    },
    onError: (error, resultType) => {
      console.error("결과 저장 실패:", error)
      router.push(`/tests/food-review/test/result?type=${resultType}`)
    },
  })
  ...
  useEffect(() => {
    trackTestStart("food-review")
  }, [])

  useEffect(() => {
    if (currentQuestion > 0) {
      trackTestProgress("food-review", currentQuestion + 1, questions.length)
    }
  }, [currentQuestion, questions.length])
