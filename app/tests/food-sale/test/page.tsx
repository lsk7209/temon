...
const questions = [
  {
    id: 1,
    q: "할인 상품 선택 빈도는?",
    a1: { text: "정기적으로 같은 할인 상품", tags: ["J"] },
    a2: { text: "매번 다른 할인 상품", tags: ["P"] },
  },
  {
    id: 2,
    q: "할인 상품 선택 계획은?",
    a1: { text: "미리 계획하고 선택", tags: ["J"] },
    a2: { text: "즉흥적으로 선택", tags: ["P"] },
  },
  {
    id: 3,
    q: "할인 상품 선택 기준은?",
  ...
  },
  {
    id: 4,
    q: "할인 상품 선택 변경은?",
    a1: { text: "고정된 할인 상품 유지", tags: ["J"] },
    a2: { text: "자주 변경", tags: ["P"] },
  },
  {
    id: 5,
    q: "할인 상품 선택 참여는?",
    a1: { text: "다른 사람과 함께 선택", tags: ["E"] },
    a2: { text: "혼자 선택", tags: ["I"] },
  },
  {
    id: 6,
    q: "할인 상품 선택 패턴은?",
    a1: { text: "새로운 할인 상품 시도", tags: ["N"] },
    a2: { text: "익숙한 할인 상품 선택", tags: ["S"] },
  },
  {
    id: 7,
    q: "할인 상품 선택 이유는?",
