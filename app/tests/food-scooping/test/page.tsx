...
const questions = [
  {
    id: 1,
    q: "음식 떠 먹기 빈도는?",
    a1: { text: "항상 떠서 먹기", tags: ["E"] },
    a2: { text: "가끔 떠서 먹기", tags: ["I"] },
  },
  {
    id: 2,
    q: "음식 떠 먹기 방식은?",
    a1: { text: "아주 많이 떠서 먹기", tags: ["N"] },
    a2: { text: "적당히 떠서 먹기", tags: ["S"] },
  },
  {
    id: 3,
    q: "음식 떠 먹기 선택은?",
    a1: { text: "즉흥적으로 떠 먹기", tags: ["P"] },
    a2: { text: "계획적으로 떠 먹기", tags: ["J"] },
  },
  {
    id: 4,
    q: "음식 떠 먹기 이유는?",
  ...
  },
  {
    id: 5,
    q: "음식 떠 먹기 속도는?",
    a1: { text: "빠르게 떠 먹기", tags: ["E"] },
    a2: { text: "천천히 떠 먹기", tags: ["I"] },
  },
  {
    id: 6,
    q: "음식 떠 먹기 대처는?",
    a1: { text: "즉시 떠 먹기", tags: ["P"] },
...
export default function FoodScoopingTest() {
  ...
  const { saveResult, isSaving } = useTestResult({
    ...
    onSuccess: (resultId, resultType) => {
      router.push(`/tests/food-scooping/test/result?type=${resultType}&id=${resultId}`)
    },
    onError: (error, resultType) => {
      console.error("결과 저장 실패:", error)
      router.push(`/tests/food-scooping/test/result?type=${resultType}`)
    },
  })
  ...
  useEffect(() => {
    trackTestStart("food-scooping")
  }, [])

  useEffect(() => {
    if (currentQuestion > 0) {
      trackTestProgress("food-scooping", currentQuestion + 1, questions.length)
    }
  }, [currentQuestion, questions.length])
        ...
        <Card className="border-0 shadow-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur">
          <CardContent className="p-8">
            <div className="text-center mb-8">
              <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-br from-orange-400 via-amber-400 to-yellow-400 flex items-center justify-center shadow-lg">
              ...
              <button
                ...
                className={`w-full p-6 text-left rounded-2xl border-2 transition-all duration-300 transform hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 ${
                  selectedChoice === currentQ.a1.tags.join(",")
                    ? "border-orange-500 bg-gradient-to-r from-orange-50 via-amber-50 to-yellow-50 dark:from-orange-950 dark:via-amber-950 dark:to-yellow-950 shadow-lg"
