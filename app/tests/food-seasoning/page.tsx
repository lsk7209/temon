...
const shortDescription = "양념 사용량과 방식으로 16유형 성향을 분석합니다. 양념 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "양념 사용량과 방식으로 16유형 성향을 분석합니다. 양념 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "food-seasoning",
  title: "양념 사용 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "양념 테스트, 조미료, 양념 사용, 취향, 성향 테스트, 심리테스트, 무료 테스트",
...
export default function FoodSeasoningIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="food-seasoning-quiz-schema" data={schemas.quiz} />
      <JsonLd id="food-seasoning-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="food-seasoning-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Food Seasoning Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Food Seasoning Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="food-seasoning" title="Next Quizzes Search Visitors Usually Click" />
        </div>
