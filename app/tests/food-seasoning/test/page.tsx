...
const questions = [
  {
    id: 1,
    q: "양념 사용량은?",
    a1: { text: "적게, 절제적으로", tags: ["T"] },
    a2: { text: "많이, 풍부하게", tags: ["F"] },
  },
  {
    id: 2,
    q: "양념 선택 기준은?",
    a1: { text: "레시피 따라, 정확하게", tags: ["S"] },
    a2: { text: "감으로, 직관적으로", tags: ["N"] },
  },
  {
    id: 3,
    q: "양념 시도는?",
    a1: { text: "익숙한 양념, 기본 양념", tags: ["S"] },
    a2: { text: "새로운 양념, 실험", tags: ["N"] },
  },
  {
    id: 4,
    q: "양념 준비는?",
  ...
  },
  {
    id: 5,
    q: "양념 조합은?",
    a1: { text: "정해진 조합, 체계적으로", tags: ["J"] },
    a2: { text: "즉흥 조합, 자유롭게", tags: ["P"] },
  },
  {
    id: 6,
    q: "양념 이유는?",
    a1: { text: "맛, 감성", tags: ["F"] },
    a2: { text: "건강, 실용", tags: ["T"] },
  },
  {
    id: 7,
    q: "양념 측정은?",
    a1: { text: "정확히 측정", tags: ["J"] },
  ...
  },
  {
    ...
    a2: { text: "혼자만 사용", tags: ["I"] },
  },
  {
    id: 9,
    q: "양념 저장은?",
    a1: { text: "체계적으로 정리", tags: ["J"] },
    a2: { text: "자유롭게 보관", tags: ["P"] },
  },
  {
    id: 10,
    q: "양념 시도 빈도는?",
    a1: { text: "자주 시도, 적극적으로", tags: ["E"] },
    a2: { text: "가끔 시도, 신중하게", tags: ["I"] },
  },
  {
    id: 11,
    q: "양념 선호는?",
    a1: { text: "전통 양념, 기본 양념", tags: ["S"] },
    a2: { text: "퓨전 양념, 창의 양념", tags: ["N"] },
  },
  {
    id: 12,
    q: "양념 후 느낌은?",
