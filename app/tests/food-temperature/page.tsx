...
export const metadata: Metadata = {
  title: "음식 온도 선호도 테스트 | 온도로 보는 16유형 | 테몬",
  description:
    "뜨거운 음식 vs 차가운 음식 선호로 16유형 성향을 분석합니다. 온도 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "음식 온도 테스트, 뜨거운 음식, 차가운 음식, 선호도, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/food-temperature",
  },
  openGraph: {
    title: "음식 온도 선호도 테스트 | 온도로 보는 16유형",
    description: "뜨거운 음식 vs 차가운 음식 선호로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/food-temperature",
  },
}
