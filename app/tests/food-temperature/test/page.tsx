...
const questions = [
  {
    id: 1,
    q: "국물 음식 선호는?",
    a1: { text: "뜨거운 국물", tags: ["F"] },
    a2: { text: "차가운 국물", tags: ["T"] },
  },
  {
    id: 2,
    q: "음료 선택은?",
    a1: { text: "뜨거운 음료", tags: ["F"] },
    a2: { text: "차가운 음료", tags: ["T"] },
  },
  {
    id: 3,
    q: "계절별 선호는?",
    a1: { text: "계절 따라 선택", tags: ["S"] },
    a2: { text: "계절 무관 선호", tags: ["N"] },
  },
  {
    id: 4,
    q: "식사 시작은?",
    a1: { text: "뜨거운 것부터", tags: ["J"] },
    a2: { text: "차가운 것부터", tags: ["P"] },
  },
  {
    id: 5,
    q: "온도 선택 이유는?",
  ...
  },
  {
    id: 7,
    q: "음식 온도 관리는?",
    a1: { text: "계획적으로 유지", tags: ["J"] },
    a2: { text: "자연스럽게 변화", tags: ["P"] },
  },
  {
    id: 8,
    q: "온도 선호 공유는?",
  ...
  },
  {
    id: 9,
    q: "온도 선택 기준은?",
    a1: { text: "익숙한 온도", tags: ["S"] },
    a2: { text: "새로운 온도", tags: ["N"] },
  },
  {
    id: 10,
    q: "온도 변화 대처는?",
...
export default function FoodTemperatureTest() {
  ...
  const { saveResult, isSaving } = useTestResult({
    ...
    onSuccess: (resultId, resultType) => {
      router.push(`/tests/food-temperature/test/result?type=${resultType}&id=${resultId}`)
    },
    onError: (error, resultType) => {
      console.error("결과 저장 실패:", error)
      router.push(`/tests/food-temperature/test/result?type=${resultType}`)
    },
  })
  ...
  useEffect(() => {
    trackTestStart("food-temperature")
  }, [])

  useEffect(() => {
    if (currentQuestion > 0) {
      trackTestProgress("food-temperature", currentQuestion + 1, questions.length)
    }
  }, [currentQuestion, questions.length])
        ...
        <Card className="border-0 shadow-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur">
          <CardContent className="p-8">
            <div className="text-center mb-8">
              <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-br from-red-400 to-blue-500 flex items-center justify-center shadow-lg">
              ...
              <button
                ...
                className={`w-full p-6 text-left rounded-2xl border-2 transition-all duration-300 transform hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 ${
                  selectedChoice === currentQ.a1.tags.join(",")
                    ? "border-red-500 bg-gradient-to-r from-red-50 to-blue-50 dark:from-red-950 dark:to-blue-950 shadow-lg"
