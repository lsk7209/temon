...
const shortDescription = "부드러운 vs 쫄깃한 질감 선호로 16유형 성향을 분석합니다. 질감 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "부드러운 vs 쫄깃한 질감 선호로 16유형 성향을 분석합니다. 질감 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "음식 질감 테스트, 식감, 부드러운 음식, 쫄깃한 음식, 선호도, 성향 테스트, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("음식 질감 선호도 테스트"),
]
...
export default function FoodTextureIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="food-texture-quiz-schema" data={schemas.quiz} />
      <JsonLd id="food-texture-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="food-texture-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Food Texture Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Food Texture Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="food-texture" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="음식 질감 선호도 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
