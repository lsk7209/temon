...
export const metadata: Metadata = {
  title: "식사 시간대 테스트 | 시간대로 보는 16유형 | 테몬",
  description:
    "식사 시간대와 규칙성으로 16유형 성향을 분석합니다. 시간대 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "식사 시간 테스트, 식사 시간대, 규칙성, 생활 패턴, 선호도, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/food-timing",
  },
  openGraph: {
    title: "식사 시간대 테스트 | 시간대로 보는 16유형",
    description: "식사 시간대와 규칙성으로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/food-timing",
  },
}
