...
const fullDescription = "선물 선택 기준, 포장 방식으로 16유형 성향을 분석합니다. 선물 고르는 방식으로 알아보는 나의 성격. 12문항, 결과 공유 이미지 자동 생성."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "gift-choosing",
  title: "선물 고르는 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "선물 테스트, 선물 고르기, 선물 선택, 포장 스타일, 성향 테스트, 심리테스트, 무료 테스트",
...
export default function GiftChoosingIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="gift-choosing-quiz-schema" data={schemas.quiz} />
      <JsonLd id="gift-choosing-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="gift-choosing-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Gift Choosing Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Gift Choosing Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="gift-choosing" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="선물 고르는 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
