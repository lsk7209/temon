...
const questions = [
  {
    id: 1,
    q: "선물 선택 기준은?",
    a1: { text: "실용적인 선물, 필요로 하는 것", tags: ["T"] },
    a2: { text: "감성적인 선물, 의미 있는 것", tags: ["F"] },
  },
  {
    id: 2,
    q: "선물 포장은?",
    a1: { text: "예쁘게 포장, 정성스럽게", tags: ["F"] },
  ...
  },
  {
    ...
    a2: { text: "당일 구매, 즉흥적으로", tags: ["P"] },
  },
  {
    id: 4,
    q: "선물 선택 방법은?",
    a1: { text: "계획적으로, 리스트 작성", tags: ["J"] },
    a2: { text: "즉흥적으로, 그때그때", tags: ["P"] },
  },
  {
    id: 5,
    q: "선물 가격은?",
    a1: { text: "예산 내에서, 합리적으로", tags: ["T"] },
    a2: { text: "의미 중시, 가격은 부차적", tags: ["F"] },
  },
  {
    id: 6,
    q: "선물 주는 감정은?",
  ...
  },
  {
    id: 7,
    q: "선물 선택 기준은?",
    a1: { text: "인기 선물, 트렌드", tags: ["S"] },
    a2: { text: "특별한 선물, 독특함", tags: ["N"] },
  },
  {
    id: 8,
    q: "선물 주는 사람은?",
  ...
  },
  {
    id: 10,
    q: "선물 선택 이유는?",
    a1: { text: "필요, 실용", tags: ["T"] },
    a2: { text: "의미, 감성", tags: ["F"] },
  },
  {
    id: 11,
    q: "선물 후기는?",
