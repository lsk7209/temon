...
const shortDescription = "장보기 스타일로 알아보는 나의 성격 유형 테스트"
// Full description for Google/AI
const fullDescription = "장보기 스타일 테스트로 알아보는 나의 성격! 12개의 질문으로 16가지 유형 중 당신은 어떤 유형일까요? 재미있는 장보기 스타일 테스트를 지금 바로 무료로 시작해보세요."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "grocery-shopping",
  title: "장보기 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "장보기 스타일 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  canonical: "/tests/grocery-shopping",
  questionCount: 12,
  duration: "PT3M",
})

const faqs = [
  ...getTopicQuizFAQs("장보기 스타일 테스트"),
]
...
export default function GroceryShoppingPage() {
  ...
  return (
    <>
      ...
      <JsonLd id="grocery-shopping-quiz-schema" data={schemas.quiz} />
      <JsonLd id="grocery-shopping-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="grocery-shopping-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-16">
          ...
          <CardContent className="p-8 md:p-12 text-center space-y-8">
            ...
            <div className="pt-8">
              <Button asChild size="lg" className="bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 hover:from-green-600 hover:via-emerald-600 hover:to-teal-600 text-white text-lg px-8 py-6">
                <Link href="/tests/grocery-shopping/test">테스트 시작하기</Link>
              </Button>
            </div>
            ...
            <div className="pt-8 text-left space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                장보기 스타일과 구매 방식을 선택하는 패턴, 장보기를 즐기는 스타일을 통해 당신의 성격 유형을 분석합니다. 
                장보기 스타일은 외향성, 내향성, 감성, 논리성 등 다양한 성격 특성을 반영합니다.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Grocery Shopping Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Grocery Shopping Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="grocery-shopping" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="장보기 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
