...
export default function HotelBreakfastResultPage() {
  return <MBTIResultPage testId="hotel-breakfast" title="호텔 조식 공략법" results={HOTEL_BREAKFAST_RESULTS} accentClass="text-orange-600"  gradientClass="from-orange-50 to-amber-100" />
}
