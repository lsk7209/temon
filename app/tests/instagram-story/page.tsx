...
const shortDescription = "인스타그램 스토리 올리는 방식으로 16유형 성향을 분석합니다. 필터, 업로드 빈도, 스토리 내용으로 알아보는 나의 성격. 12문항, 결과 ..."
// Full description for Google/AI
const fullDescription = "인스타그램 스토리 올리는 방식으로 16유형 성향을 분석합니다. 필터, 업로드 빈도, 스토리 내용으로 알아보는 나의 성격. 12문항, 결과 공유 이미지 자동 생성."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "instagram-story",
  title: "인스타그램 스토리 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "인스타그램 테스트, 스토리 스타일, 필터 선택, SNS 성향 테스트, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("인스타그램 스토리 스타일 테스트"),
]
...
export default function InstagramStoryIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="instagram-story-quiz-schema" data={schemas.quiz} />
      <JsonLd id="instagram-story-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="instagram-story-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Instagram Story Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Instagram Story Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="instagram-story" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="인스타그램 스토리 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
