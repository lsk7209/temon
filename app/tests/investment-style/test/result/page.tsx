...
export default function InvestmentStyleResultPage() {
  return <MBTIResultPage testId="investment-style" title="주식 투자 스타일" results={INVESTMENT_STYLE_RESULTS} accentClass="text-green-600"  gradientClass="from-green-50 to-emerald-100" />
}
