        ...
        <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 dark:from-pink-950 dark:via-purple-950 dark:to-blue-950">
          <main className="container max-w-4xl mx-auto px-4 py-8">
                ...
                <CardContent className="p-8 text-left">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      <AccordionTrigger>
                        K-드라마 클리셰 테스트란 무엇인가요?
                      </AccordionTrigger>
                      <AccordionContent>
                        드라마에서 자주 등장하는 뻔하지만 재밌는
                        상황(클리셰)에서의 선택을 통해 당신의 성향을 분석하는
                        테스트입니다. 10가지 흥미진진한 상황이 준비되어
                        있습니다.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent>
                        재벌 2세 본부장, 캔디형 여주인공, 서브 남주, 악녀 등
                        드라마 속 대표적인 캐릭터 유형 중 당신과 가장 닮은
                        캐릭터를 MBTI 기반으로 분석해 알려줍니다.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3">
                      ...
                      <AccordionContent>
                        MBTI 성격 유형 이론을 드라마 상황에 대입하여 분석하므로,
                        꽤 높은 정확도를 자랑합니다. 하지만 드라마는 드라마일
                        뿐! 재미로 즐겨주세요.
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
            ...
            <section className="mt-12 mb-8">
              <FAQSection
                faqs={faqs}
                title="K-드라마 클리셰 테스트 - 무료 성격 테스트 자주 묻는 질문"
              />
            </section>
          </main>
        </div>
