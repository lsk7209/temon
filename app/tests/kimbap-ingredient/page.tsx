...
export const metadata: Metadata = {
  title: "김밥 재료 선택 테스트 | 김밥 재료로 보는 16유형 | 테몬",
  description:
    "김밥 재료 선택으로 16유형 성향을 분석합니다. 김밥에 넣는 재료로 알아보는 나의 성격. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "김밥 테스트, 김밥 재료, 재료 선택, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/kimbap-ingredient",
  },
  openGraph: {
    title: "김밥 재료 선택 테스트 | 김밥 재료로 보는 16유형",
    description: "김밥 재료 선택으로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/kimbap-ingredient",
  },
}
