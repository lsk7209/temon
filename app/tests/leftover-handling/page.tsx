...
const shortDescription = "남은 음식을 다루는 방식으로 16유형 성향을 분석합니다. 처리 방식에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "남은 음식을 다루는 방식으로 16유형 성향을 분석합니다. 처리 방식에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "leftover-handling",
  title: "남은 음식 처리 테스트",
  shortDescription,
  fullDescription,
  keywords: "음식 테스트, 남은 음식, 처리 방식, 성향 테스트, 심리테스트, 무료 테스트",
...
export default function LeftoverHandlingIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="leftover-handling-quiz-schema" data={schemas.quiz} />
      <JsonLd id="leftover-handling-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="leftover-handling-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Leftover Handling Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Leftover Handling Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="leftover-handling" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="남은 음식 처리 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
