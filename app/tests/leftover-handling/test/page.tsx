...
const questions = [
  ...
  },
  {
    id: 2,
    q: "보관 방법은?",
    a1: { text: "정확히, 라벨 붙이기", tags: ["S"] },
    a2: { text: "대충, 편하게", tags: ["N"] },
  },
  {
    id: 3,
    q: "처리 기준은?",
    a1: { text: "감성, 아까운 마음", tags: ["F"] },
    a2: { text: "실용, 효율성", tags: ["T"] },
  },
  {
    id: 4,
    q: "나눔 태도는?",
    a1: { text: "적극적으로 나눔", tags: ["E"] },
    a2: { text: "조용히 처리", tags: ["I"] },
  },
  {
    id: 5,
    q: "활용 방식은?",
    a1: { text: "그대로 먹기", tags: ["S"] },
    a2: { text: "창의적으로 변형", tags: ["N"] },
  },
  {
    id: 6,
    q: "처리 시점은?",
    a1: { text: "즉시, 바로", tags: ["J"] },
    a2: { text: "나중에, 여유있게", tags: ["P"] },
  },
  {
    id: 7,
    q: "처리 후 느낌은?",
    a1: { text: "뿌듯함, 만족감", tags: ["F"] },
    a2: { text: "효율성, 합리성", tags: ["T"] },
  },
  {
    id: 8,
    q: "처리 후 활동은?",
  ...
  },
  {
    id: 9,
    q: "보관 공간은?",
    a1: { text: "정해진 자리", tags: ["J"] },
    a2: { text: "빈 곳 아무데나", tags: ["P"] },
  },
  {
    id: 10,
    q: "처리 스타일은?",
    a1: { text: "전통적, 익숙한 방식", tags: ["S"] },
    a2: { text: "실험적, 새로운 방식", tags: ["N"] },
  },
  {
    id: 11,
    q: "처리 동기는?",
    a1: { text: "감성, 아깝다", tags: ["F"] },
    a2: { text: "논리, 효율적", tags: ["T"] },
  },
  {
    id: 12,
    q: "처리 후 정리는?",
    a1: { text: "깨끗이 정리", tags: ["E"] },
    a2: { text: "최소한으로", tags: ["I"] },
  },
]
