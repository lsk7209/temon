...
const questions = [
  {
    id: 1,
    q: "점심 30분 전, 당신의 준비는?",
    a1: { text: "동료 일정 확인하고 후보를 미리 정리한다", tags: ["J"] },
    a2: { text: "그때 상황 보고 즉흥적으로 정한다", tags: ["P"] },
  },
  {
    id: 2,
    q: "회사 근처에 새 식당이 생겼다. 오늘 선택은?",
  ...
  },
  {
    id: 9,
    q: "업무가 바쁘다. 점심 전략은?",
    a1: { text: "시간 고정, 가까운 곳으로 신속히", tags: ["J"] },
    a2: { text: "배달이나 간편식을 상황 따라 선택", tags: ["P"] },
  },
  {
    id: 10,
    q: "색다른 조합 제안이 나왔다.",
  ...
  },
  {
    id: 12,
    q: "식후 커피나 디저트 추가는?",
    a1: { text: "예산·시간을 보고 합리적으로 결정", tags: ["T"] },
    a2: { text: "컨디션과 기분이 좋으면 추가", tags: ["F"] },
  },
]
