...
export const metadata: Metadata = {
  title: "밀프렙 스타일 테스트 | 식사 준비로 보는 16유형 | 테몬",
  description:
    "식사 준비 방식(밀프렙 vs 즉석)으로 16유형 성향을 분석합니다. 식사 준비 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "밀프렙 테스트, 식사 준비, 요리, 계획성, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/meal-prep",
  },
  openGraph: {
    title: "밀프렙 스타일 테스트 | 식사 준비로 보는 16유형",
    description: "식사 준비 방식(밀프렙 vs 즉석)으로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/meal-prep",
  },
}
