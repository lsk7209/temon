...
const shortDescription = "고기 굽는 방식, 익힘 정도 선호로 16유형 성향을 분석합니다. 고기 한 점에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "고기 굽는 방식, 익힘 정도 선호로 16유형 성향을 분석합니다. 고기 한 점에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "meat-grilling",
  title: "고기 굽는 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "고기 테스트, 고기 굽기, 굽는 방식, 성향 테스트, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("고기 굽는 스타일 테스트"),
]
...
export default function MeatGrillingIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="meat-grilling-quiz-schema" data={schemas.quiz} />
      <JsonLd id="meat-grilling-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="meat-grilling-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Meat Grilling Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Meat Grilling Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="meat-grilling" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="고기 굽는 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
