...
const shortDescription = "아침 알람을 대하는 방식으로 알아보는 나의 성격 유형. 알람이 울렸을 때, 스누즈를 눌렀을 때 등 구체적인 상황으로 분석합니다."
// Full description for Google/AI
const fullDescription = "아침 알람을 대하는 방식으로 알아보는 나의 성격 유형. 알람이 울렸을 때, 스누즈를 눌렀을 때 등 구체적인 상황으로 분석합니다."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "morning-alarm",
  title: "아침 알람 대하는 방식 테스트",
  shortDescription,
  fullDescription,
  keywords: "아침 알람, 기상 습관, 알람 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("아침 알람 대하는 방식 테스트"),
]
    ...
    <>
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-20 space-y-12">
          ...
          <RelatedTestsSection testId="morning-alarm" />
        </div>
      
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Morning Alarm Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Morning Alarm Test" />
        </div>
