...
export const metadata: Metadata = {
  title: "아침 식사 스타일 테스트 | 16유형 분석 | 테몬",
  description:
    "아침에 식사하는 스타일로 알아보는 나의 성격 유형. 아침에 배가 고플 때, 아침 식사 시간이 부족할 때 등 구체적인 상황으로 분석합니다.",
  keywords:
    "아침 식사, 식사 습관, 아침 식사 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/morning-breakfast",
  },
  openGraph: {
    title: "아침 식사 스타일 테스트 | 16유형 분석",
    description: "아침에 식사하는 스타일로 알아보는 나의 성격 유형. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/morning-breakfast",
  },
}
