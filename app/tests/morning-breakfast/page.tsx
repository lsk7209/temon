...
const shortDescription = "아침에 식사하는 스타일로 알아보는 나의 성격 유형. 아침에 배가 고플 때, 아침 식사 시간이 부족할 때 등 구체적인 상황으로 분석합니다."
// Full description for Google/AI
const fullDescription = "아침에 식사하는 스타일로 알아보는 나의 성격 유형. 아침에 배가 고플 때, 아침 식사 시간이 부족할 때 등 구체적인 상황으로 분석합니다."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "morning-breakfast",
  title: "아침 식사 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "아침 식사, 식사 습관, 아침 식사 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  canonical: "/tests/morning-breakfast",
  questionCount: 12,
  duration: "PT3M",
})

const faqs = [
  ...getTopicQuizFAQs("아침 식사 스타일 테스트"),
]

export default function MorningBreakfastIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="morning-breakfast-quiz-schema" data={schemas.quiz} />
      <JsonLd id="morning-breakfast-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="morning-breakfast-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              아침에 배가 고플 때, 아침 식사 시간이 부족할 때 등 구체적인 상황으로 16유형 분석. 12문항, 약 3분 소요.
            </p>

            <div className="flex justify-center items-center space-x-8 text-sm text-muted-foreground">
              <div className="flex items-center space-x-2">
                <Users className="h-4 w-4" />
                <span>15,856명 참여</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="mt-20 space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                  <div className="space-y-4">
                    <div className="p-4 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                      <p className="font-medium">1. 아침에 배가 고플 때</p>
                      <p className="text-sm text-muted-foreground mt-1">바로 간단하게 먹는다 vs 여유롭게 준비해서 먹는다</p>
                    </div>
                    <div className="p-4 bg-orange-50 dark:bg-orange-950 rounded-lg">
                      <p className="font-medium">2. 아침 식사 시간이 부족할 때</p>
                      <p className="text-sm text-muted-foreground mt-1">빠르게 간단하게 먹는다 vs 시간을 내서 먹는다</p>
                    </div>
                    <div className="p-4 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                      <p className="font-medium">3. 아침 식사를 준비할 때</p>
                      <p className="text-sm text-muted-foreground mt-1">정해진 메뉴로 준비한다 vs 그때그때 다르게 준비한다</p>
                    </div>
                  </div>

                  <div className="space-y-4">
                    <div className="p-4 bg-orange-50 dark:bg-orange-950 rounded-lg">
                      <p className="font-medium">4. 아침 식사를 먹는 장소를 고를 때</p>
                      <p className="text-sm text-muted-foreground mt-1">집에서 먹는다 vs 밖에서 먹는다</p>
                    </div>
                    <div className="p-4 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                      <p className="font-medium">5. 아침 식사를 먹는 시간을 정할 때</p>
                      <p className="text-sm text-muted-foreground mt-1">정해진 시간에 먹는다 vs 그때그때 먹는다</p>
                    </div>
                    <div className="p-4 bg-orange-50 dark:bg-orange-950 rounded-lg">
                      <p className="font-medium">6. 아침 식사를 먹으면서 할 일</p>
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur">
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                <h2 className="text-2xl font-bold">🍳 16가지 식사 스타일</h2>
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Morning Breakfast Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Morning Breakfast Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="morning-breakfast" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="아침 식사 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
