...
const shortDescription = "아침에 커피를 마시는 방식으로 알아보는 나의 성격 유형. 커피를 마실 때, 커피가 식었을 때 등 구체적인 상황으로 분석합니다."
// Full description for Google/AI
const fullDescription = "아침에 커피를 마시는 방식으로 알아보는 나의 성격 유형. 커피를 마실 때, 커피가 식었을 때 등 구체적인 상황으로 분석합니다."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "morning-coffee",
  title: "아침 커피 마시는 방식 테스트",
  shortDescription,
  fullDescription,
  keywords: "아침 커피, 커피 습관, 커피 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("아침 커피 마시는 방식 테스트"),
]
  ...
  return (
    <>
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Morning Coffee Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Morning Coffee Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="morning-coffee" title="Next Quizzes Search Visitors Usually Click" />
        </div>
