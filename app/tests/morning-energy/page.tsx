...
import { Clock, Users, Sun, Sparkles } from "lucide-react"

// Naver-optimized description (under 80 chars)
const shortDescription = "아침에 에너지를 관리하는 방식으로 알아보는 나의 성격 유형. 아침에 피곤할 때, 아침에 에너지가 넘칠 때 등 구체적인 상황으로 분석합니다."
// Full description for Google/AI
const fullDescription = "아침에 에너지를 관리하는 방식으로 알아보는 나의 성격 유형. 아침에 피곤할 때, 아침에 에너지가 넘칠 때 등 구체적인 상황으로 분석합니다."
...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "아침 에너지, 에너지 관리, 에너지 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("아침 에너지 관리 테스트"),
]
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              아침에 피곤할 때, 아침에 에너지가 넘칠 때 등 구체적인 상황으로 16유형 분석. 12문항, 약 3분 소요.
            </p>

            <div className="flex justify-center items-center space-x-8 text-sm text-muted-foreground">
              <div className="flex items-center space-x-2">
                <Users className="h-4 w-4" />
                <span>16,496명 참여</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="mt-20 space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                  <div className="space-y-4">
                    <div className="p-4 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                      <p className="font-medium">1. 아침에 피곤할 때</p>
                      <p className="text-sm text-muted-foreground mt-1">에너지를 충전하기 위해 무언가를 한다 vs 그냥 쉰다</p>
                    </div>
                    <div className="p-4 bg-orange-50 dark:bg-orange-950 rounded-lg">
                      <p className="font-medium">2. 아침에 에너지가 넘칠 때</p>
                      <p className="text-sm text-muted-foreground mt-1">바로 할 일을 시작한다 vs 여유롭게 즐긴다</p>
                    </div>
                    <div className="p-4 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                      <p className="font-medium">3. 아침에 에너지를 관리할 때</p>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-orange-50 dark:bg-orange-950 rounded-lg">
                      <p className="font-medium">4. 아침에 에너지를 충전할 때</p>
                      <p className="text-sm text-muted-foreground mt-1">운동이나 활동을 한다 vs 휴식이나 명상을 한다</p>
                    </div>
                    <div className="p-4 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                      <p className="font-medium">5. 아침에 에너지를 사용할 때</p>
                      <p className="text-sm text-muted-foreground mt-1">효율적으로 사용한다 vs 여유롭게 사용한다</p>
                    </div>
                    <div className="p-4 bg-orange-50 dark:bg-orange-950 rounded-lg">
                      <p className="font-medium">6. 아침에 에너지를 관리하는 이유</p>
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur">
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                <h2 className="text-2xl font-bold">⚡ 16가지 에너지 스타일</h2>
                <p className="text-muted-foreground">당신은 어떤 에너지러일까요?</p>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">12문항으로 에너지 관리 습관을 4축으로 정량화해 유형화</p>
                  </div>
                  ...
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">당신의 유형에 맞는 에너지 관리 추천 및 건강 팁 제공</p>
                  </div>
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Morning Energy Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Morning Energy Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="morning-energy" title="Next Quizzes Search Visitors Usually Click" />
        </div>
