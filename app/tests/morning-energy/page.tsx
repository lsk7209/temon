...
export const metadata: Metadata = {
  title: "아침 에너지 관리 테스트 | 16유형 분석 | 테몬",
  description:
    "아침에 에너지를 관리하는 방식으로 알아보는 나의 성격 유형. 아침에 피곤할 때, 아침에 에너지가 넘칠 때 등 구체적인 상황으로 분석합니다.",
  keywords:
    "아침 에너지, 에너지 관리, 에너지 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/morning-energy",
  },
  openGraph: {
    title: "아침 에너지 관리 테스트 | 16유형 분석",
    description: "아침에 에너지를 관리하는 방식으로 알아보는 나의 성격 유형. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/morning-energy",
  },
}
