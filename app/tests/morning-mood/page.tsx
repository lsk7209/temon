...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "아침 기분, 기분 관리, 심리 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
...
export default function MorningMoodIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="morning-mood-quiz-schema" data={schemas.quiz} />
      <JsonLd id="morning-mood-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="morning-mood-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <LandingConversionSection quizTitle="Morning Mood Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="morning-mood" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="아침 기분 관리 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
