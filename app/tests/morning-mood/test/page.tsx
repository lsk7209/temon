...
const questions = [
  {
    id: 1,
    q: "아침에 기분이 안 좋을 때",
    a1: { text: "기분을 전환하기 위해 무언가를 한다", tags: ["E", "F"] },
    a2: { text: "그냥 둔다", tags: ["I", "T"] },
  },
  {
    id: 2,
    q: "아침에 좋은 일이 생겼을 때",
    a1: { text: "즉시 기분을 표현한다", tags: ["E", "F"] },
    a2: { text: "조용히 즐긴다", tags: ["I", "T"] },
  },
  {
    id: 3,
    q: "아침에 기분을 관리할 때",
  ...
  },
  {
    id: 4,
    q: "아침에 기분을 전환할 때",
    a1: { text: "활동이나 운동을 한다", tags: ["E", "T"] },
    a2: { text: "휴식이나 명상을 한다", tags: ["I", "F"] },
  },
  {
    id: 5,
    q: "아침에 기분을 표현할 때",
    a1: { text: "사람들과 함께 표현한다", tags: ["E", "F"] },
    a2: { text: "혼자만의 시간을 즐긴다", tags: ["I", "T"] },
  },
  {
    id: 6,
    q: "아침에 기분을 관리하는 이유",
...
export default function MorningMoodTest() {
  ...
  const handleChoiceSelect = async (tags: string[]) => {
    ...
    trackTestProgress("morning-mood", currentQuestion + 1, questions.length)
    ...
    if (currentQuestion < questions.length - 1) {
      ...
      try {
        ...
        router.push(`/tests/morning-mood/test/result?type=${result}&id=${resultId}`)
      } catch (error) {
        console.error("결과 저장 실패:", error)
        router.push(`/tests/morning-mood/test/result?type=${result}`)
      }
    }
  }
