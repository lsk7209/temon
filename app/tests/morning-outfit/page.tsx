...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "아침 옷, 패션 선택, 옷 고르기 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
...
export default function MorningOutfitIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="morning-outfit-quiz-schema" data={schemas.quiz} />
      <JsonLd id="morning-outfit-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="morning-outfit-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <LandingConversionSection quizTitle="Morning Outfit Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="morning-outfit" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="아침 옷 고르기 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
