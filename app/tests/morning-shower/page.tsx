...
const shortDescription = "아침에 샤워하는 습관으로 알아보는 나의 성격 유형. 샤워할 때, 샤워 중에 생각이 떠올랐을 때 등 구체적인 상황으로 분석합니다."
// Full description for Google/AI
const fullDescription = "아침에 샤워하는 습관으로 알아보는 나의 성격 유형. 샤워할 때, 샤워 중에 생각이 떠올랐을 때 등 구체적인 상황으로 분석합니다."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "morning-shower",
  title: "아침 샤워 습관 테스트",
  shortDescription,
  fullDescription,
  keywords: "아침 샤워, 샤워 습관, 샤워 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
...
export default function MorningShowerIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="morning-shower-quiz-schema" data={schemas.quiz} />
      <JsonLd id="morning-shower-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="morning-shower-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Morning Shower Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Morning Shower Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="morning-shower" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="아침 샤워 습관 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
