...
const questions: QuizQuestion[] = [
  { id: 1, q: "🖥️ 멀티디바이스 생산성 테스트 상황에서 나는", a1: { text: "먼저 계획과 기준을 세운다", tags: ["I", "J"] }, a2: { text: "빠르게 실행하며 조정한다", tags: ["E", "P"] } },
...
export default function TestPage() {
  const quizLogic = useQuizLogic({ testId: "multi-device-productivity", questions, resultPath: "/tests/multi-device-productivity/test/result" })
