...
export const metadata: Metadata = {
  title: "면 먹는 스타일 테스트 | 면 먹기로 보는 16유형 | 테몬",
  description:
    "면 먹는 방식과 속도로 16유형 성향을 분석합니다. 면 한 젓가락에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "면 테스트, 식습관, 습관, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/noodle-eating",
  },
  openGraph: {
    title: "면 먹는 스타일 테스트 | 면 먹기로 보는 16유형",
    description: "면 먹는 방식과 속도로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/noodle-eating",
  },
}
