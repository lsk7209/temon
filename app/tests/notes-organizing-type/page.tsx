...
export const metadata: Metadata = {
  title: "🗂️ 회의록 정리 성향 테스트 | 테몬",
  description: "요약·구조화 습관으로 알아보는 정보 정리 타입. 12문항, 3분 완성.",
  alternates: { canonical: "/tests/notes-organizing-type" },
  openGraph: {
    title: "🗂️ 회의록 정리 성향 테스트",
    description: "요약·구조화 습관으로 알아보는 정보 정리 타입",
    type: "website",
    url: "https://temon.kr/tests/notes-organizing-type",
  },
}
    ...
    <div className="min-h-screen bg-[#F7FAFC] dark:bg-gray-950">
      <main className="container max-w-4xl mx-auto px-4 py-10">
        <div className="text-center space-y-8">
          ...
          <div className="mx-auto w-24 h-24 rounded-full bg-gradient-to-br from-zinc-500 to-slate-600 flex items-center justify-center shadow-lg">
            <FileText className="h-12 w-12 text-white" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">🗂️ 회의록 정리 성향 테스트</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">요약·구조화 습관으로 알아보는 정보 정리 타입</p>
          ...
          <Button asChild size="lg" className="h-14 px-10 text-lg">
            <Link href="/tests/notes-organizing-type/test"><Sparkles className="h-5 w-5 mr-2" /> 테스트 시작하기</Link>
          </Button>
        </div>
      </main>
    </div>
