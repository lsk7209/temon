...
const shortDescription =
  "NTRP 테스트로 당신의 테니스 실력을 정확하게 측정해보세요! NTRP 공식 기준으로 1.0부터 7.0까지 정확한 레벨을 무료로 알아보는 ...";
...
export const metadata: Metadata = generateQuizMetadata({
  ...
  fullDescription,
  keywords:
    "NTRP, 테니스 실력, 테니스 레벨, 테니스 테스트, 스포츠 테스트, 무료 테스트",
  canonical: "/tests/ntrp-test",
  questionCount: 15,
  duration: "PT3M",
});

const faqs = [...getTopicQuizFAQs("NTRP 테스트 - 무료 테니스 실력 측정")];
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 dark:from-green-950 dark:via-emerald-950 dark:to-teal-950">
        <main className="container max-w-4xl mx-auto px-4 py-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <Button
                  ...
                  asChild
                >
                  <Link href="/tests/ntrp-test/test">
          ...
          <TestExpandedIntro testId="ntrp-test" />

          <div className="mt-12">
            <AutoGscLandingBoost testId="ntrp-test" />
          ...
          <div className="mt-12">
            <RelatedTestsSection testId="ntrp-test" />
          </div>
          ...
          <section className="mt-12 mb-8">
            <FAQSection
              faqs={faqs}
              title="NTRP 테스트 - 무료 테니스 실력 측정 자주 묻는 질문"
            />
          </section>
        </main>
      </div>
