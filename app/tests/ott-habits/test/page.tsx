...
const questions = [
  ...
  },
  {
    id: 3,
    q: "재생 속도는?",
    a1: { text: "기본 속도, 디테일을 놓치기 싫다", tags: ["S", "T"] },
    a2: { text: "상황 따라 가속, 리듬이 중요", tags: ["N", "F"] },
  },
  {
    id: 4,
  ...
  },
  {
    id: 5,
    q: "드라마 정주행 방식은?",
    a1: { text: "매일 같은 시간에 일정량씩", tags: ["J", "I"] },
    a2: { text: "주말 몰아보기로 한 번에", tags: ["P", "E"] },
  },
  {
    id: 6,
    q: "시청 중 메시지가 오면?",
  ...
  },
  {
    id: 7,
    q: "장르 선택 기준은?",
    a1: { text: "검증된 시리즈·제작진 위주", tags: ["S", "T"] },
    a2: { text: "새로운 세계관·아이디어", tags: ["N", "F"] },
  },
  {
    id: 8,
    q: "스포일러를 대하는 태도는?",
    a1: { text: "철저 차단, 규칙을 세움", tags: ["J", "I"] },
    a2: { text: "가벼운 스포는 괜찮다", tags: ["P", "E"] },
  },
  {
    id: 9,
    q: "시청 후 기록은?",
    a1: { text: "평점·노트·좋았던 씬 저장", tags: ["S", "J"] },
    a2: { text: "인상적인 감정만 기억", tags: ["N", "P"] },
  },
  {
    id: 10,
    q: "친구가 추천을 부탁하면?",
  ...
  },
  {
    id: 12,
    q: "퇴근 후 피곤한 날의 선택은?",
    a1: { text: "익숙한 작품 재탕으로 회복", tags: ["S", "I"] },
    a2: { text: "짧은 하이라이트·클립 탐색", tags: ["N", "E"] },
  },
]
