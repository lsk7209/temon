...
const questions: QuizQuestion[] = [
  { id: 1, q: "📣 퍼스널 브랜딩 콘텐츠 성향 테스트에서 시작할 때 나는", a1: { text: "배경과 맥락을 먼저 정리한다", tags: ["I", "N"] }, a2: { text: "바로 실행하며 반응을 본다", tags: ["E", "S"] } },
...
export default function TestPage() {
  const quizLogic = useQuizLogic({
    ...
    questions,
    resultPath: "/tests/personal-brand-content-type/test/result",
  })
