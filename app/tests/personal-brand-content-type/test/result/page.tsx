        ...
        <Card className="border-0 shadow-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur">
          <CardContent className="p-8 space-y-6 text-center">
            <div className="space-y-2">
              <div className="text-sm text-muted-foreground">📣 퍼스널 브랜딩 콘텐츠 성향 테스트 결과</div>
              <h1 className="text-3xl md:text-4xl font-bold">{label} ({type})</h1>
              <p className="text-muted-foreground">발행 주제와 톤 선택으로 보는 1인 브랜드 운영 타입에 강점이 있는 유형입니다.</p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-3 justify-center">
              <ShareButtons
                testId="personal-brand-content-type"
                testPath="/tests/personal-brand-content-type/test"
                resultType={type}
                resultId={resultId}
              ...
              <Button variant="outline" asChild>
                <Link href="/tests/personal-brand-content-type/test"><RotateCcw className="h-4 w-4 mr-2" /> 다시 테스트</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
