...
export const metadata: Metadata = generateQuizMetadata({
  ...
  fullDescription,
  keywords:
    "반려동물 MBTI, 반려동물 테스트, 성격 테스트, MBTI, 반려동물 유형, 심리테스트, 무료 테스트",
  canonical: "/tests/pet-mbti",
  questionCount: 12,
  duration: "PT2M",
});

const faqs = [...getTopicQuizFAQs("반려동물 MBTI 테스트 - 무료 성격 테스트")];
        ...
        <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 dark:from-pink-950 dark:via-purple-950 dark:to-blue-950 relative overflow-hidden">
          ...
          <main className="container max-w-4xl mx-auto px-4 py-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="text-center space-y-3">
                        ...
                        <p className="text-sm text-muted-foreground">
                          12가지 라이프스타일 질문으로 MBTI 4축 정확 분석
                        </p>
                      </div>
                ...
                <CardContent className="p-8 text-left">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      <AccordionTrigger>
                        반려동물을 키우지 않아도 테스트할 수 있나요?
                      </AccordionTrigger>
                      <AccordionContent>
                        네, 물론입니다! 현재 반려동물이 없더라도 당신의
                        라이프스타일과 성향을 바탕으로 가장 잘 어울리는
                        반려동물을 추천해드립니다. 미래의 반려동물을 미리
                        만나보는 재미를 느껴보세요.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent>
                        강아지, 고양이뿐만 아니라 햄스터, 앵무새, 거북이,
                        고슴도치 등 다양한 반려동물 중 당신의 성격과 찰떡궁합인
                        친구를 찾아드립니다.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3">
                      ...
                      <AccordionContent>
                        MBTI 성격 유형 이론을 바탕으로 반려동물의 특성과
                        매칭하여 분석하므로, 꽤 높은 정확도를 자랑합니다. 하지만
                        재미로 즐겨주시는 것을 추천드려요!
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
            ...
            <section className="mt-12 mb-8">
              <FAQSection
                faqs={faqs}
                title="반려동물 MBTI 테스트 - 무료 성격 테스트 자주 묻는 질문"
              />
            </section>
          </main>
        </div>
