...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "배터리, 스마트폰, 배터리 관리, 디지털 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  canonical: "/tests/phone-battery",
  questionCount: 12,
  duration: "PT3M",
})

const faqs = [
  ...getTopicQuizFAQs("배터리 관리 테스트"),
]

export default function PhoneBatteryIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="phone-battery-quiz-schema" data={schemas.quiz} />
      <JsonLd id="phone-battery-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="phone-battery-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-center text-muted-foreground">
                무료 • 회원가입 불필요 • 16가지 배터리 관리 스타일 분석
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 space-y-12">
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur">
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                <h2 className="text-2xl font-bold">🔋 16가지 배터리 관리 스타일</h2>
                <p className="text-muted-foreground">당신은 어떤 배터리러일까요?</p>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">12문항으로 배터리 관리 습관을 4축으로 정량화해 유형화</p>
                  </div>
                  ...
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">당신의 유형에 맞는 배터리 관리 스타일 및 절전 팁 제공</p>
                  </div>
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Phone Battery Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Phone Battery Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="phone-battery" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="배터리 관리 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
