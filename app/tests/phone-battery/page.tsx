...
export const metadata: Metadata = {
  title: "배터리 관리 테스트 | 16유형 분석 | 테몬",
  description:
    "스마트폰 배터리를 관리하는 방식으로 알아보는 나의 성격 유형. 배터리가 20% 남았을 때, 배터리가 다 떨어졌을 때 등 구체적인 상황으로 분석합니다.",
  keywords:
    "배터리, 스마트폰, 배터리 관리, 디지털 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/phone-battery",
  },
  openGraph: {
    title: "배터리 관리 테스트 | 16유형 분석",
    description: "스마트폰 배터리를 관리하는 방식으로 알아보는 나의 성격 유형. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/phone-battery",
  },
}
