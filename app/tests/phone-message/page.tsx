...
const shortDescription = "phone message로 알아보는 나의 성격 유형 테스트"
// Full description for Google/AI
const fullDescription = "phone message로 알아보는 나의 성격! 12개의 질문으로 16가지 유형 중 당신은 어떤 유형일까요? 재미있는 phone message를 지금 바로 무료로 시작해보세요."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "phone-message",
  title: "phone message",
  shortDescription,
  fullDescription,
...
const faqs = [
  ...getTopicQuizFAQs("phone message"),
]
...
export default function PhoneMessageIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="phone-message-quiz-schema" data={schemas.quiz} />
      <JsonLd id="phone-message-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="phone-message-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              메시지가 왔을 때, 읽씹을 당했을 때 등 구체적인 상황으로 16유형 분석. 12문항, 약 3분 소요.
            </p>

            <div className="flex justify-center items-center space-x-8 text-sm text-muted-foreground">
              <div className="flex items-center space-x-2">
                <Users className="h-4 w-4" />
                <span>11,077명 참여</span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-center text-muted-foreground">
                무료 • 회원가입 불필요 • 16가지 메시지 답장 스타일 분석
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                  <div className="space-y-4">
                    <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
                      <p className="font-medium">1. 메시지가 왔을 때</p>
                      <p className="text-sm text-muted-foreground mt-1">즉시 답장한다 vs 나중에 답장한다</p>
                    </div>
                    <div className="p-4 bg-pink-50 dark:bg-pink-950 rounded-lg">
                      <p className="font-medium">2. 읽씹을 당했을 때</p>
                      <p className="text-sm text-muted-foreground mt-1">신경 쓰인다 vs 신경 쓰이지 않는다</p>
                    </div>
                    <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
                      <p className="font-medium">3. 메시지를 답장하는 방식</p>
                      <p className="text-sm text-muted-foreground mt-1">짧게 답장한다 vs 길게 답장한다</p>
                    </div>
                  </div>

                  <div className="space-y-4">
                    <div className="p-4 bg-pink-50 dark:bg-pink-950 rounded-lg">
                      <p className="font-medium">4. 메시지를 답장하는 시간</p>
                      <p className="text-sm text-muted-foreground mt-1">정해진 시간에 답장한다 vs 그때그때 답장한다</p>
                    </div>
                    <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
                      <p className="font-medium">5. 메시지를 답장하는 이유</p>
                      <p className="text-sm text-muted-foreground mt-1">목표와 효율을 위해 vs 기분과 컨디션을 위해</p>
                    </div>
                    <div className="p-4 bg-pink-50 dark:bg-pink-950 rounded-lg">
                      <p className="font-medium">6. 메시지를 선택하는 기준</p>
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur">
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                <h2 className="text-2xl font-bold">💬 16가지 메시지 답장 스타일</h2>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">12문항으로 메시지 답장 습관을 4축으로 정량화해 유형화</p>
                  </div>
                  ...
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">당신의 유형에 맞는 메시지 답장 스타일 및 소통 팁 제공</p>
                  </div>
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Phone Message Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Phone Message Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="phone-message" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="phone message 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
