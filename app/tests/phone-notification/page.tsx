...
export const metadata: Metadata = {
  title: "알림 대하는 방식 테스트 | 16유형 분석 | 테몬",
  description:
    "스마트폰 알림을 대하는 방식으로 알아보는 나의 성격 유형. 알림이 올 때, 알림이 너무 많을 때 등 구체적인 상황으로 분석합니다.",
  keywords:
    "알림, 스마트폰, 알림 설정, 디지털 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/phone-notification",
  },
  openGraph: {
    title: "알림 대하는 방식 테스트 | 16유형 분석",
    description: "스마트폰 알림을 대하는 방식으로 알아보는 나의 성격 유형. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/phone-notification",
  },
}
