...
const fullDescription = "스마트폰으로 사진을 찍는 습관으로 알아보는 나의 성격 유형. 예쁜 것을 봤을 때, 사진을 찍고 싶을 때 등 구체적인 상황으로 분석합니다."
...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "사진, 스마트폰, 사진 습관, 디지털 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
...
export default function PhonePhotoIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="phone-photo-quiz-schema" data={schemas.quiz} />
      <JsonLd id="phone-photo-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="phone-photo-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Phone Photo Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Phone Photo Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="phone-photo" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="사진 찍는 습관 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
