...
export const metadata: Metadata = {
  title: "저장공간 관리 테스트 | 16유형 분석 | 테몬",
  description:
    "스마트폰 저장공간을 관리하는 방식으로 알아보는 나의 성격 유형. 저장공간이 부족할 때, 사진을 정리해야 할 때 등 구체적인 상황으로 분석합니다.",
  keywords:
    "저장공간, 스마트폰, 저장공간 관리, 디지털 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/phone-storage",
  },
  openGraph: {
    title: "저장공간 관리 테스트 | 16유형 분석",
    description: "스마트폰 저장공간을 관리하는 방식으로 알아보는 나의 성격 유형. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/phone-storage",
  },
}
