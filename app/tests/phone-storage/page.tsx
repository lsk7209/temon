...
import { Clock, Users, HardDrive, Sparkles } from "lucide-react"

// Naver-optimized description (under 80 chars)
const shortDescription = "스마트폰 저장공간을 관리하는 방식으로 알아보는 나의 성격 유형. 저장공간이 부족할 때, 사진을 정리해야 할 때 등 구체적인 상황으로 분석합니다."
// Full description for Google/AI
const fullDescription = "스마트폰 저장공간을 관리하는 방식으로 알아보는 나의 성격 유형. 저장공간이 부족할 때, 사진을 정리해야 할 때 등 구체적인 상황으로 분석합니다."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "phone-storage",
  title: "저장공간 관리 테스트",
  shortDescription,
  fullDescription,
  keywords: "저장공간, 스마트폰, 저장공간 관리, 디지털 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  canonical: "/tests/phone-storage",
  questionCount: 12,
  duration: "PT3M",
})

const faqs = [
  ...getTopicQuizFAQs("저장공간 관리 테스트"),
]

export default function PhoneStorageIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="phone-storage-quiz-schema" data={schemas.quiz} />
      <JsonLd id="phone-storage-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="phone-storage-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              저장공간이 부족할 때, 사진을 정리해야 할 때 등 구체적인 상황으로 16유형 분석. 12문항, 약 3분 소요.
            </p>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-center text-muted-foreground">
                무료 • 회원가입 불필요 • 16가지 저장공간 관리 스타일 분석
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 space-y-12">
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur">
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                <h2 className="text-2xl font-bold">💾 16가지 저장공간 관리 스타일</h2>
                <p className="text-muted-foreground">당신은 어떤 저장공간러일까요?</p>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">12문항으로 저장공간 관리 습관을 4축으로 정량화해 유형화</p>
                  </div>
                  ...
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">당신의 유형에 맞는 저장공간 관리 스타일 및 정리 팁 제공</p>
                  </div>
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Phone Storage Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Phone Storage Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="phone-storage" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="저장공간 관리 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
