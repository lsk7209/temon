/**
 * Component: PhoneStyleTest
 * 스마트폰 사용 스타일 테스트 페이지
 * @example <PhoneStyleTest />
 */
...
import { PHONE_STYLE_QUESTIONS } from "@/lib/data/phone-style-questions"
import { decideType } from "@/lib/utils/phone-style-scorer"
import type { QuizQuestion } from "@/hooks/use-quiz-logic"

// Convert external questions to QuizQuestion format
const questions: QuizQuestion[] = PHONE_STYLE_QUESTIONS.map((q) => ({
  id: q.id,
  q: q.text,
...
const calculatePhoneStyleResult = (answers: string[][]): string => {
...
export default function PhoneStyleTest() {
  const quizLogic = useQuizLogic({
    testId: "phone-style",
    questions,
    resultPath: "/tests/phone-style/test/result",
    calculateResult: calculatePhoneStyleResult,
  })
