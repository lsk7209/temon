...
const shortDescription = "피자 토핑 선택 습관으로 16유형 성향을 분석합니다. 페퍼로니, 치즈, 야채 선택으로 알아보는 나의 성격. 12문항, 결과 공유 이미지 자..."
// Full description for Google/AI
const fullDescription = "피자 토핑 선택 습관으로 16유형 성향을 분석합니다. 페퍼로니, 치즈, 야채 선택으로 알아보는 나의 성격. 12문항, 결과 공유 이미지 자동 생성."
...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "피자 테스트, 피자 토핑, 토핑 선택, 피자 MBTI, 음식 성향 테스트, 심리테스트, 무료 테스트",
  ...
  return (
    <>
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Pizza Topping Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Pizza Topping Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="pizza-topping" title="Next Quizzes Search Visitors Usually Click" />
        </div>
