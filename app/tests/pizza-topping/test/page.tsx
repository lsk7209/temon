...
const questions = [
  {
    id: 1,
    q: "피자 토핑을 고를 때 당신은?",
    a1: { text: "항상 페퍼로니로 고정", tags: ["J"] },
    a2: { text: "그때그때 다양한 토핑 시도", tags: ["P"] },
  },
  {
    id: 2,
    q: "치즈는 필수인가요?",
  ...
  },
  {
    id: 3,
    q: "야채 토핑은?",
    a1: { text: "야채 빼기, 고기만", tags: ["T"] },
    a2: { text: "야채 가득, 영양 고려", tags: ["F"] },
  },
  {
    id: 4,
    q: "피자 주문할 때 당신은?",
    a1: { text: "메뉴 미리 정해둠", tags: ["J"] },
    a2: { text: "그때그때 결정", tags: ["P"] },
  },
  {
    id: 5,
    q: "피자 조각 선택은?",
    a1: { text: "가장 큰 조각", tags: ["S"] },
    a2: { text: "토핑 많은 조각", tags: ["N"] },
  },
  {
    id: 6,
    q: "피자를 먹는 순서는?",
    a1: { text: "가장자리부터 차근차근", tags: ["J"] },
    a2: { text: "가운데부터, 가장 맛있는 부분", tags: ["P"] },
  },
  {
    id: 7,
    q: "피자 사진을 찍을 때?",
  ...
  },
  {
    id: 10,
    q: "피자 토핑 조합은?",
    a1: { text: "클래식 조합만", tags: ["S"] },
    a2: { text: "신기한 조합 시도", tags: ["N"] },
  },
  {
    id: 11,
    q: "피자를 먹고 난 후?",
