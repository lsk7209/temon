...
const questions = [
  ...
  },
  {
    id: 2,
    q: "식당 선택 기준은?",
    a1: { text: "리뷰, 정보 분석", tags: ["T"] },
    a2: { text: "느낌, 직감", tags: ["F"] },
  },
  {
    id: 3,
    q: "메뉴 선택은?",
    a1: { text: "익숙한 메뉴, 기본 메뉴", tags: ["S"] },
    a2: { text: "새로운 메뉴, 특별한 메뉴", tags: ["N"] },
  },
  {
    id: 4,
    q: "식당 선택 시간은?",
  ...
  },
  {
    id: 6,
    q: "선택 이유는?",
    a1: { text: "감성, 분위기", tags: ["F"] },
    a2: { text: "실용, 효율", tags: ["T"] },
  },
  {
    id: 7,
    q: "식당 찾는 방식은?",
    a1: { text: "검색, 정보 수집", tags: ["J"] },
    a2: { text: "둘러보기, 탐색", tags: ["P"] },
  },
  {
    id: 8,
    q: "선택 후 느낌은?",
  ...
  },
  {
    id: 10,
    q: "메뉴 선택 계획은?",
    a1: { text: "미리 생각, 체계적으로", tags: ["J"] },
    a2: { text: "그때그때, 즉흥적으로", tags: ["P"] },
  },
  {
    id: 11,
    q: "식당 경험 후 활동은?",
    a1: { text: "공유하기, 리뷰 쓰기", tags: ["E"] },
