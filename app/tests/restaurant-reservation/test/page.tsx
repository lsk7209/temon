...
const questions = [
  {
    id: 1,
    q: "식당 예약 빈도는?",
    a1: { text: "정기적으로 예약", tags: ["J"] },
    a2: { text: "필요할 때마다 예약", tags: ["P"] },
  },
  {
    id: 2,
    q: "식당 예약 계획은?",
    a1: { text: "미리 계획하고 예약", tags: ["J"] },
    a2: { text: "즉흥적으로 예약", tags: ["P"] },
  },
  {
    id: 3,
    q: "식당 예약 선택 기준은?",
  ...
  },
  {
    id: 4,
    q: "식당 예약 변경은?",
    a1: { text: "계획대로 예약", tags: ["J"] },
    a2: { text: "자주 변경", tags: ["P"] },
  },
  {
    id: 5,
    q: "식당 예약 참여는?",
    a1: { text: "다른 사람과 함께 예약", tags: ["E"] },
    a2: { text: "혼자 예약", tags: ["I"] },
  },
  {
    id: 6,
    q: "식당 예약 패턴은?",
    a1: { text: "새로운 식당 시도", tags: ["N"] },
    a2: { text: "익숙한 식당 선택", tags: ["S"] },
  },
  {
    id: 7,
    q: "식당 예약 이유는?",
  ...
  },
  {
    ...
    a2: { text: "혼자만 예약", tags: ["I"] },
  },
  {
    id: 9,
    q: "식당 예약 준비는?",
    a1: { text: "미리 준비", tags: ["J"] },
    a2: { text: "그때그때 예약", tags: ["P"] },
  },
  {
    id: 10,
    q: "식당 예약 경험 활용은?",
