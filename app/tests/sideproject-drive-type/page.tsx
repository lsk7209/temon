...
import { Clock3, Sparkles, Rocket } from "lucide-react"

export const metadata: Metadata = {
  title: "🚀 사이드프로젝트 추진력 테스트 | 테몬",
  description: "아이디어 실행·협업 방식으로 보는 프로젝트 추진 성향. 12문항, 3분 완성.",
  alternates: { canonical: "/tests/sideproject-drive-type" },
  openGraph: {
    title: "🚀 사이드프로젝트 추진력 테스트",
    description: "아이디어 실행·협업 방식으로 보는 프로젝트 추진 성향",
    type: "website",
    url: "https://temon.kr/tests/sideproject-drive-type",
  },
}
    ...
    <div className="min-h-screen bg-[#F7FAFC] dark:bg-gray-950">
      <main className="container max-w-4xl mx-auto px-4 py-10">
        <div className="text-center space-y-8">
          ...
          <div className="mx-auto w-24 h-24 rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center shadow-lg">
            <Rocket className="h-12 w-12 text-white" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">🚀 사이드프로젝트 추진력 테스트</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">아이디어 실행·협업 방식으로 보는 프로젝트 추진 성향</p>
          ...
          <Button asChild size="lg" className="h-14 px-10 text-lg">
            <Link href="/tests/sideproject-drive-type/test"><Sparkles className="h-5 w-5 mr-2" /> 테스트 시작하기</Link>
          </Button>
        </div>
      </main>
    </div>
