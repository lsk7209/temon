...
const shortDescription = "간식 선호도로 알아보는 나의 성격 유형 테스트"
// Full description for Google/AI
const fullDescription = "간식 선호도 테스트로 알아보는 나의 성격! 12개의 질문으로 16가지 유형 중 당신은 어떤 유형일까요? 재미있는 간식 선호도 테스트를 지금 바로 무료로 시작해보세요."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "snack-preference",
  title: "간식 선호도 테스트",
  shortDescription,
  fullDescription,
  keywords: "간식 선호도 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  canonical: "/tests/snack-preference",
  questionCount: 12,
  duration: "PT3M",
})

const faqs = [
  ...getTopicQuizFAQs("간식 선호도 테스트"),
]

export default function SnackPreferencePage() {
  ...
  return (
    <>
      ...
      <JsonLd id="snack-preference-quiz-schema" data={schemas.quiz} />
      <JsonLd id="snack-preference-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="snack-preference-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-16">
          ...
          <CardContent className="p-8 md:p-12 text-center space-y-8">
            ...
            <div className="pt-8">
              <Button asChild size="lg" className="bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white text-lg px-8 py-6">
                <Link href="/tests/snack-preference/test">테스트 시작하기</Link>
              </Button>
            </div>
            ...
            <div className="pt-8 text-left space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                간식에 대한 선호도와 간식을 선택하는 방식, 간식을 즐기는 패턴을 통해 당신의 성격 유형을 분석합니다. 
                간식에 대한 선호도는 생활 패턴, 안정성, 감각 추구, 논리적 선택 등 다양한 성격 특성을 반영합니다.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Snack Preference Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Snack Preference Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="snack-preference" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="간식 선호도 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
