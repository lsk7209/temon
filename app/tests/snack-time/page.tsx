...
const shortDescription = "간식 먹는 시간대와 선택으로 16유형 성향을 분석합니다. 간식 한 입에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "간식 먹는 시간대와 선택으로 16유형 성향을 분석합니다. 간식 한 입에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "간식 테스트, 야식, 디저트, 식습관, 성향 테스트, 심리테스트, 무료 테스트",
...
export default function SnackTimeIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="snack-time-quiz-schema" data={schemas.quiz} />
      <JsonLd id="snack-time-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="snack-time-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Snack Time Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Snack Time Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="snack-time" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="간식 시간대 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
