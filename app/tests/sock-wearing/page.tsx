...
export const metadata: Metadata = {
  title: "양말 신는 스타일 테스트 | 양말 선택으로 보는 16유형 | 테몬",
  description:
    "양말 선택, 신는 방식으로 16유형 성향을 분석합니다. 양말 한 짝에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "양말 테스트, 양말 선택, 신는 방식, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/sock-wearing",
  },
  openGraph: {
    title: "양말 신는 스타일 테스트 | 양말 선택으로 보는 16유형",
    description: "양말 선택, 신는 방식으로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/sock-wearing",
  },
}
