...
const shortDescription = "국물 마시는 방식과 선호도로 16유형 성향을 분석합니다. 국물 한 숟가락에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "국물 마시는 방식과 선호도로 16유형 성향을 분석합니다. 국물 한 숟가락에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "국물 테스트, 식습관, 습관, 성향 테스트, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("국물 먹는 스타일 테스트"),
]
...
export default function SoupEatingIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="soup-eating-quiz-schema" data={schemas.quiz} />
      <JsonLd id="soup-eating-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="soup-eating-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Soup Eating Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Soup Eating Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="soup-eating" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="국물 먹는 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
