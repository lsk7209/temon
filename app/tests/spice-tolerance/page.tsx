...
const shortDescription = "매운맛 선호도와 대처 방식으로 16유형 성향을 분석합니다. 매운맛 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."
// Full description for Google/AI
const fullDescription = "매운맛 선호도와 대처 방식으로 16유형 성향을 분석합니다. 매운맛 한 번에 내 성격이. 12문항, 결과 공유 이미지 자동 생성."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "spice-tolerance",
  title: "매운맛 선호도 테스트",
  shortDescription,
  fullDescription,
  keywords: "매운맛 테스트, 매운맛 선호도, 맛 테스트, 성향 테스트, 심리테스트, 무료 테스트",
...
export default function SpiceToleranceIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="spice-tolerance-quiz-schema" data={schemas.quiz} />
      <JsonLd id="spice-tolerance-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="spice-tolerance-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Spice Tolerance Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Spice Tolerance Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="spice-tolerance" title="Next Quizzes Search Visitors Usually Click" />
        </div>
