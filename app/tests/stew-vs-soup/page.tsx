...
export const metadata: Metadata = {
  title: "찌개 vs 국물 스타일 테스트 | 찌개 종류 선택으로 보는 16유형 | 테몬",
  description:
    "찌개 종류 선택, 국물 마시는 습관으로 16유형 성향을 분석합니다. 찌개 한 그릇에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "찌개 테스트, 국물 테스트, 찌개 종류, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/stew-vs-soup",
  },
  openGraph: {
    title: "찌개 vs 국물 스타일 테스트 | 찌개 종류 선택으로 보는 16유형",
    description: "찌개 종류 선택, 국물 마시는 습관으로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/stew-vs-soup",
  },
}
