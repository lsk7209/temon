...
const questions = [
  {
    id: 1,
    q: "찌개 종류 선택은?",
    a1: { text: "된장찌개, 김치찌개, 전통 찌개", tags: ["S"] },
    a2: { text: "부대찌개, 특별한 찌개, 새로운 찌개", tags: ["N"] },
  },
  {
    id: 2,
    q: "국물 마시는 방식은?",
    a1: { text: "많이 마시기, 풍부하게", tags: ["T"] },
    a2: { text: "적게 마시기, 적당히", tags: ["F"] },
  },
  {
    id: 3,
    q: "찌개 끓이는 방식은?",
    a1: { text: "오래 끓이기, 체계적으로", tags: ["J"] },
    a2: { text: "빨리 끓이기, 유연하게", tags: ["P"] },
  },
  {
    id: 4,
    q: "찌개 재료 선택은?",
    a1: { text: "전통 재료, 기본 재료", tags: ["S"] },
