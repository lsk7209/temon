...
export const metadata: Metadata = generateQuizMetadata({
  ...
  fullDescription,
  keywords:
    "공부 MBTI, 공부 테스트, 학습 스타일, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  canonical: "/tests/study-mbti",
  questionCount: 12,
  duration: "PT5M",
});

const faqs = [...getTopicQuizFAQs("공부 MBTI 테스트 - 무료 성격 테스트")];
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950 dark:via-purple-950 dark:to-pink-950">
          ...
          <main className="container max-w-4xl mx-auto px-4 py-8">
            <div className="text-center space-y-8">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                  형광펜 덕후부터 올빵 벼락치기까지, 5분 만에 내 학습 DNA
                  확인하기
                </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                      ...
                      <div className="space-y-4">
                        <div className="p-4 bg-indigo-50 dark:bg-indigo-950 rounded-lg">
                          ...
                          <p className="text-sm text-muted-foreground mt-1">
                            글머리·도형·컬러 완벽 vs 연상·그림·밈 활용
                          </p>
                        </div>
                        <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
                          <p className="font-medium">⏰ 시험 2주 전</p>
                          <p className="text-sm text-muted-foreground mt-1">
                            데일리 스터디 플랜 vs 마감 압박받아야 달림
                          </p>
                        </div>
                        <div className="p-4 bg-pink-50 dark:bg-pink-950 rounded-lg">
                          <p className="font-medium">
                ...
                <CardContent className="p-8 text-left">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      <AccordionTrigger>
                        이 테스트가 성적 향상에 도움이 되나요?
                      </AccordionTrigger>
                      <AccordionContent>
                        자신의 학습 스타일을 이해하는 것은 효율적인 공부의
                        첫걸음입니다. 본인에게 맞는 공부법과 환경을 찾아
                        적용하면 성적 향상에 긍정적인 영향을 줄 수 있습니다.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent>
                        형광펜 덕후, 벼락치기 장인, 계획표 신봉자, 스터디 그룹
                        리더 등 16가지의 재미있고 공감 가는 공부 유형으로
                        분석해드립니다. 친구들과 서로의 유형을 비교해보세요.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3">
                      ...
                      <AccordionContent>
                        MBTI 이론을 학습 상황에 적용하여 분석하므로 높은
                        공감도를 자랑합니다. 하지만 개인마다 차이가 있을 수
                        있으니, 맹신하기보다는 참고용으로 활용해주세요.
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
            ...
            <section className="mt-12 mb-8">
              <FAQSection
                faqs={faqs}
                title="공부 MBTI 테스트 - 무료 성격 테스트 자주 묻는 질문"
              />
            </section>
          </main>
        </div>
