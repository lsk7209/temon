...
export const metadata: Metadata = {
  title: "맛 선호도 테스트 | 맛으로 보는 16유형 | 테몬",
  description:
    "단맛/쓴맛/짠맛/신맛 선호로 16유형 성향을 분석합니다. 맛 한 입에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "맛 테스트, 취향, 식습관, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/taste-preference",
  },
  openGraph: {
    title: "맛 선호도 테스트 | 맛으로 보는 16유형",
    description: "단맛/쓴맛/짠맛/신맛 선호로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/taste-preference",
  },
}
