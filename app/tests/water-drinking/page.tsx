...
export const metadata: Metadata = {
  title: "물 마시는 습관 테스트 | 물 마시는 방식으로 보는 16유형 | 테몬",
  description:
    "물 마시는 방식, 습관으로 16유형 성향을 분석합니다. 물 한 잔에 내 성격이. 12문항, 결과 공유 이미지 자동 생성.",
  keywords:
    "물 테스트, 물 마시기, 마시는 습관, 성향 테스트, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/water-drinking",
  },
  openGraph: {
    title: "물 마시는 습관 테스트 | 물 마시는 방식으로 보는 16유형",
    description: "물 마시는 방식, 습관으로 16유형 성향을 분석합니다. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/water-drinking",
  },
}
