...
export default function WeekendBalanceIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="weekend-balance-quiz-schema" data={schemas.quiz} />
      <JsonLd id="weekend-balance-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="weekend-balance-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <LandingConversionSection quizTitle="Weekend Balance Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="weekend-balance" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="주말 균형잡기 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
