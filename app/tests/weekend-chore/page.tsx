...
const shortDescription = "주말에 집안일을 하는 방식으로 알아보는 나의 성격 유형. 주말에 집안일을 할 때, 주말에 빨래를 해야 할 때 등 구체적인 상황으로 분석합니다."
// Full description for Google/AI
const fullDescription = "주말에 집안일을 하는 방식으로 알아보는 나의 성격 유형. 주말에 집안일을 할 때, 주말에 빨래를 해야 할 때 등 구체적인 상황으로 분석합니다."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "weekend-chore",
  title: "주말 집안일 테스트",
  shortDescription,
  fullDescription,
  keywords: "주말 집안일, 집안일, 주말 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  canonical: "/tests/weekend-chore",
  questionCount: 12,
  duration: "PT3M",
})

const faqs = [
  ...getTopicQuizFAQs("주말 집안일 테스트"),
]

export default function WeekendChoreIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="weekend-chore-quiz-schema" data={schemas.quiz} />
      <JsonLd id="weekend-chore-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="weekend-chore-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              주말에 집안일을 할 때, 주말에 빨래를 해야 할 때 등 구체적인 상황으로 16유형 분석. 12문항, 약 3분 소요.
            </p>

            <div className="flex justify-center items-center space-x-8 text-sm text-muted-foreground">
              <div className="flex items-center space-x-2">
                <Users className="h-4 w-4" />
                <span>11,860명 참여</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="mt-20 space-y-12">
            ...
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-emerald-50 dark:bg-emerald-950 rounded-lg">
                      <p className="font-medium">4. 주말에 집안일을 하는 시간</p>
                      <p className="text-sm text-muted-foreground mt-1">정해진 시간에 한다 vs 그때그때 한다</p>
                    </div>
                    <div className="p-4 bg-green-50 dark:bg-green-950 rounded-lg">
                      <p className="font-medium">5. 주말에 집안일을 하는 이유</p>
                      <p className="text-sm text-muted-foreground mt-1">목표와 효율을 위해 vs 기분과 컨디션을 위해</p>
                    </div>
                    <div className="p-4 bg-emerald-50 dark:bg-emerald-950 rounded-lg">
                      <p className="font-medium">6. 주말에 집안일을 선택하는 기준</p>
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur">
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                <h2 className="text-2xl font-bold">🧹 16가지 집안일 스타일</h2>
                <p className="text-muted-foreground">당신은 어떤 집안일러일까요?</p>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">12문항으로 집안일 습관을 4축으로 정량화해 유형화</p>
                  </div>
                  ...
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">당신의 유형에 맞는 집안일 스타일 및 효율성 팁 제공</p>
                  </div>
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Weekend Chore Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Weekend Chore Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="weekend-chore" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="주말 집안일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
