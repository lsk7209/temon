...
const shortDescription = "주말에 음식을 선택하는 방식으로 알아보는 나의 성격 유형. 주말에 뭐 먹을지 고민될 때, 주말에 배달 음식을 시킬 때 등 구체적인 상황으로..."
// Full description for Google/AI
const fullDescription = "주말에 음식을 선택하는 방식으로 알아보는 나의 성격 유형. 주말에 뭐 먹을지 고민될 때, 주말에 배달 음식을 시킬 때 등 구체적인 상황으로 분석합니다."
...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "주말 음식, 음식 선택, 주말 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
...
export default function WeekendFoodIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="weekend-food-quiz-schema" data={schemas.quiz} />
      <JsonLd id="weekend-food-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="weekend-food-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Weekend Food Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Weekend Food Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="weekend-food" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="주말 음식 선택 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
