...
export const metadata: Metadata = generateQuizMetadata({
  quizId: "weekend-lazy",
  title: "주말 게으름 피우기 테스트",
  shortDescription,
  fullDescription,
  keywords: "주말 게으름, 늦잠, 주말 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  canonical: "/tests/weekend-lazy",
  questionCount: 12,
  duration: "PT3M",
})
...
export default function WeekendLazyIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="weekend-lazy-quiz-schema" data={schemas.quiz} />
      <JsonLd id="weekend-lazy-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="weekend-lazy-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              주말에 늦잠을 잘 때, 주말에 아무것도 안 하고 싶을 때 등 구체적인 상황으로 16유형 분석. 12문항, 약 3분 소요.
            </p>

            <div className="flex justify-center items-center space-x-8 text-sm text-muted-foreground">
              <div className="flex items-center space-x-2">
                <Users className="h-4 w-4" />
                <span>13,430명 참여</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="mt-20 space-y-12">
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur">
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                <h2 className="text-2xl font-bold">😴 16가지 게으름 스타일</h2>
                <p className="text-muted-foreground">당신은 어떤 게으름러일까요?</p>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">12문항으로 게으름 피우기 습관을 4축으로 정량화해 유형화</p>
                  </div>
                  ...
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">당신의 유형에 맞는 게으름 스타일 및 휴식 팁 제공</p>
                  </div>
        ...
        <div className="mt-12">
          <LandingConversionSection quizTitle="Weekend Lazy Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="weekend-lazy" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="주말 게으름 피우기 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
