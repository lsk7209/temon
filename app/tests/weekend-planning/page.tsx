...
export const metadata: Metadata = {
  title: "주말 계획 세우기 테스트 | 16유형 분석 | 테몬",
  description:
    "주말에 계획을 세우는 방식으로 알아보는 나의 성격 유형. 주말에 계획을 세울 때, 주말 계획을 변경해야 할 때 등 구체적인 상황으로 분석합니다.",
  keywords:
    "주말 계획, 계획 세우기, 주말 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
  alternates: {
    canonical: "/tests/weekend-planning",
  },
  openGraph: {
    title: "주말 계획 세우기 테스트 | 16유형 분석",
    description: "주말에 계획을 세우는 방식으로 알아보는 나의 성격 유형. 12문항, 결과 공유 이미지 자동 생성.",
    type: "website",
    url: "https://www.temon.kr/tests/weekend-planning",
  },
}
