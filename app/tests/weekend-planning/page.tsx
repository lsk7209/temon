...
export default function WeekendPlanningIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="weekend-planning-quiz-schema" data={schemas.quiz} />
      <JsonLd id="weekend-planning-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="weekend-planning-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              주말에 계획을 세울 때, 주말 계획을 변경해야 할 때 등 구체적인 상황으로 16유형 분석. 12문항, 약 3분 소요.
            </p>
        ...
        <div className="mt-20 space-y-12">
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur">
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                <h2 className="text-2xl font-bold">📅 16가지 계획 스타일</h2>
                <p className="text-muted-foreground">당신은 어떤 계획러일까요?</p>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">12문항으로 계획 세우기 습관을 4축으로 정량화해 유형화</p>
                  </div>
                  ...
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">당신의 유형에 맞는 계획 스타일 및 시간관리 팁 제공</p>
                  </div>
        ...
        <div className="mt-12">
          <LandingConversionSection quizTitle="Weekend Planning Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="weekend-planning" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="주말 계획 세우기 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
