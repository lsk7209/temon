...
const shortDescription = "주말에 에너지를 충전하는 방식으로 알아보는 나의 성격 유형. 주말에 에너지를 충전할 때, 주말에 완전히 쉬고 싶을 때 등 구체적인 상황으로..."
// Full description for Google/AI
const fullDescription = "주말에 에너지를 충전하는 방식으로 알아보는 나의 성격 유형. 주말에 에너지를 충전할 때, 주말에 완전히 쉬고 싶을 때 등 구체적인 상황으로 분석합니다."
...
export const metadata: Metadata = generateQuizMetadata({
  ...
  shortDescription,
  fullDescription,
  keywords: "주말 충전, 휴식, 에너지, 주말 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              주말에 에너지를 충전할 때, 주말에 완전히 쉬고 싶을 때 등 구체적인 상황으로 16유형 분석. 12문항, 약 3분 소요.
            </p>
        ...
        <div className="mt-20 space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                  <div className="space-y-4">
                    <div className="p-4 bg-violet-50 dark:bg-violet-950 rounded-lg">
                      <p className="font-medium">1. 주말에 에너지를 충전할 때</p>
                      <p className="text-sm text-muted-foreground mt-1">미리 계획을 세운다 vs 그때그때 결정한다</p>
                    </div>
                    <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
                      <p className="font-medium">2. 주말에 완전히 쉬고 싶을 때</p>
                      <p className="text-sm text-muted-foreground mt-1">계획대로 쉰다 vs 상황에 따라 조정한다</p>
                    </div>
                    <div className="p-4 bg-violet-50 dark:bg-violet-950 rounded-lg">
                      <p className="font-medium">3. 주말에 충전을 하는 방식</p>
                      <p className="text-sm text-muted-foreground mt-1">혼자 조용히 충전한다 vs 사람들과 함께 충전한다</p>
                    </div>
                  </div>

                  <div className="space-y-4">
                    <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
                      <p className="font-medium">4. 주말에 충전을 하는 시간</p>
                      <p className="text-sm text-muted-foreground mt-1">정해진 시간에 충전한다 vs 그때그때 충전한다</p>
                    </div>
                    <div className="p-4 bg-violet-50 dark:bg-violet-950 rounded-lg">
                      <p className="font-medium">5. 주말에 충전을 하는 이유</p>
                      <p className="text-sm text-muted-foreground mt-1">목표와 계획을 위해 vs 기분과 컨디션을 위해</p>
                    </div>
                    <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
                      <p className="font-medium">6. 주말에 충전 방식을 선택하는 기준</p>
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur">
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                <h2 className="text-2xl font-bold">🌙 16가지 충전 스타일</h2>
                <p className="text-muted-foreground">당신은 어떤 충전러일까요?</p>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">12문항으로 충전 습관을 4축으로 정량화해 유형화</p>
                  </div>
                  ...
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">당신의 유형에 맞는 충전 스타일 및 휴식 팁 제공</p>
                  </div>
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Weekend Rest Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Weekend Rest Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="weekend-rest" title="Next Quizzes Search Visitors Usually Click" />
        </div>
