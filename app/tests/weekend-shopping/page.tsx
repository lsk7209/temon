...
const shortDescription = "주말에 쇼핑을 하는 방식으로 알아보는 나의 성격 유형. 주말에 쇼핑을 갈 때, 주말에 쇼핑 중에 예산을 초과했을 때 등 구체적인 상황으로 ..."
// Full description for Google/AI
const fullDescription = "주말에 쇼핑을 하는 방식으로 알아보는 나의 성격 유형. 주말에 쇼핑을 갈 때, 주말에 쇼핑 중에 예산을 초과했을 때 등 구체적인 상황으로 분석합니다."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "weekend-shopping",
  title: "주말 쇼핑 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "주말 쇼핑, 쇼핑 스타일, 주말 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("주말 쇼핑 스타일 테스트"),
]
...
export default function WeekendShoppingIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="weekend-shopping-quiz-schema" data={schemas.quiz} />
      <JsonLd id="weekend-shopping-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="weekend-shopping-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <AnswerEngineSection quizTitle="Weekend Shopping Test" />
        </div>

        <div className="mt-12">
          <LandingConversionSection quizTitle="Weekend Shopping Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="weekend-shopping" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="주말 쇼핑 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
