...
const shortDescription = "주말에 모임에 가는 방식으로 알아보는 나의 성격 유형. 주말 모임에 갈 때, 주말 모임에서 시간이 지날 때 등 구체적인 상황으로 분석합니다."
// Full description for Google/AI
const fullDescription = "주말에 모임에 가는 방식으로 알아보는 나의 성격 유형. 주말 모임에 갈 때, 주말 모임에서 시간이 지날 때 등 구체적인 상황으로 분석합니다."

export const metadata: Metadata = generateQuizMetadata({
  quizId: "weekend-social",
  title: "주말 모임 스타일 테스트",
  shortDescription,
  fullDescription,
  keywords: "주말 모임, 모임 스타일, 주말 테스트, 성격 테스트, MBTI, 심리테스트, 무료 테스트",
...
const faqs = [
  ...getTopicQuizFAQs("주말 모임 스타일 테스트"),
]
...
export default function WeekendSocialIntro() {
  ...
  return (
    <>
      ...
      <JsonLd id="weekend-social-quiz-schema" data={schemas.quiz} />
      <JsonLd id="weekend-social-breadcrumb-schema" data={schemas.breadcrumb} />
      {schemas.faq && <JsonLd id="weekend-social-faq-schema" data={schemas.faq} />}
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          <LandingConversionSection quizTitle="Weekend Social Test" />
        </div>

        <div className="mt-12">
          <RelatedTestsSection testId="weekend-social" title="Next Quizzes Search Visitors Usually Click" />
        </div>

        {/* FAQ Section for AI Bot Optimization */}
        <section className="mt-12 mb-8">
          <FAQSection faqs={faqs} title="주말 모임 스타일 테스트 자주 묻는 질문" />
        </section>
</main>
    </div>
    </>
