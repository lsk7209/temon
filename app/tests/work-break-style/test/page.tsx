...
const questions: QuizQuestion[] = [
  { id: 1, q: "☕ 업무 쉬는시간 운영 테스트에서 나는", a1: { text: "계획/기준을 먼저 세운다", tags: ["I", "J"] }, a2: { text: "실행하며 조정한다", tags: ["E", "P"] } },
...
export default function TestPage() {
  const quizLogic = useQuizLogic({ testId: "work-break-style", questions, resultPath: "/tests/work-break-style/test/result" })
