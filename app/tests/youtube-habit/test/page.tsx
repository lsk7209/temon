...
const questions = [
  ...
  },
  {
    id: 2,
    q: "구독 채널 관리는?",
    a1: { text: "폴더·알림 설정까지 체계 관리", tags: ["J", "S"] },
    a2: { text: "대충 보다가 정리하려고 생각만 함", tags: ["P", "N"] },
  },
  {
    id: 3,
    q: "시청 중 댓글은?",
    a1: { text: "정보·타임스탬프 위주로 확인", tags: ["T", "I"] },
    a2: { text: "공감 댓글에 반응·대화 참여", tags: ["F", "E"] },
  },
  {
    id: 4,
    q: "영상 길이 선호는?",
    a1: { text: "10분 내외 핵심 요약", tags: ["S", "T"] },
    a2: { text: "길어도 깊게 보는 편", tags: ["N", "F"] },
  },
  {
    id: 5,
    q: "재생 속도 습관은?",
    a1: { text: "1.25~2배로 효율 시청", tags: ["T", "J"] },
    a2: { text: "기분 따라 속도 조절", tags: ["F", "P"] },
  },
  {
    id: 6,
    q: "추천 알고리즘을 믿는 편인가?",
  ...
  },
  {
    id: 9,
    q: "시청 장소와 모드는?",
    a1: { text: "집중 가능한 환경·전체화면", tags: ["I", "J"] },
    a2: { text: "이동 중 멀티태스킹", tags: ["E", "P"] },
  },
  {
    id: 10,
  ...
  },
  {
    id: 11,
    q: "좋아요와 공유는?",
    a1: { text: "참고 가치 있을 때만 눌러 기록", tags: ["I", "T"] },
    a2: { text: "재미있으면 곧장 단톡방 공유", tags: ["E", "F"] },
  },
  {
    id: 12,
    q: "이탈 포인트가 생기면?",
