          ...
          {items.map((item, index) => (
            <li key={`${item.index}-${item.label}`}>
              <button
                ...
                className="flex min-h-11 w-full items-center gap-2 rounded-md px-3 py-2 text-left transition-colors hover:bg-violet-50 hover:text-violet-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500"
              >
