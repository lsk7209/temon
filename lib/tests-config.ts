...
export const ALL_TESTS: Test[] = [
  ...
  {
    id: "worknight-recovery",
    title: "🌙 퇴근 후 회복 방식 테스트",
    description: "퇴근 후 저녁 시간을 어떻게 보내는지로 알아보는 16가지 회복 유형",
    icon: Moon,
    href: "/tests/worknight-recovery",
    color: "from-indigo-500 via-purple-500 to-violet-500",
    participants: "0",
    rating: 5.0,
    badge: "NEW",
    category: "직장",
    tags: ["직장", "퇴근", "저녁 루틴", "MBTI"],
    new: true,
    // 2026-05-07 KST 자정 드립 공개
    publishAt: "2026-05-06T15:00:00Z",
  },
  {
    id: "office-snack-habit",
    title: "🍫 사무실 간식 습관 테스트",
    description: "사무실에서의 간식 습관으로 알아보는 16가지 직장 성격 유형",
    icon: Cookie,
    href: "/tests/office-snack-habit",
    ...
    tags: ["직장", "간식", "사무실", "MBTI"],
    new: true,
    // 2026-05-09 KST 자정 드립 공개
    publishAt: "2026-05-08T15:00:00Z",
  },
  {
    id: "wfh-focus-type",
    title: "🏠 재택근무 집중 유형 테스트",
    description: "재택근무 중 집중 방식과 업무 스타일로 알아보는 16가지 원격 근무 유형",
    icon: Laptop,
    href: "/tests/wfh-focus-type",
    color: "from-teal-500 via-cyan-500 to-blue-500",
    participants: "0",
    rating: 5.0,
    badge: "NEW",
    category: "직장",
    tags: ["직장", "재택근무", "집중", "MBTI"],
    new: true,
    // 2026-05-11 KST 자정 드립 공개
    publishAt: "2026-05-10T15:00:00Z",
  },
  {
    id: "friend-distance",
    title: "👥 친구 간 거리 조절 스타일 테스트",
    description: "친구와의 거리감으로 알아보는 16가지 우정 유형",
    icon: Users,
    href: "/tests/friend-distance",
    ...
    tags: ["관계", "친구", "우정", "MBTI"],
    new: true,
    publishAt: "2026-05-13T15:00:00Z",
  },
  {
    id: "sns-reaction-style",
    title: "📱 SNS 반응 스타일 테스트",
    description: "SNS 반응 패턴으로 알아보는 16가지 디지털 소통 유형",
    icon: Smartphone,
    href: "/tests/sns-reaction-style",
    ...
    tags: ["관계", "SNS", "소통", "MBTI"],
    new: true,
    publishAt: "2026-05-15T15:00:00Z",
  },
  {
    id: "parent-comm-style",
    title: "👨‍👩‍👧 부모와 소통 방식 테스트",
    description: "부모님과 소통 방식으로 알아보는 16가지 가족 관계 유형",
    icon: HandHeart,
    href: "/tests/parent-comm-style",
  ...
  {
    id: "breakup-recovery-speed",
    title: "💔 이별 회복 속도 테스트",
    description: "이별 후 회복 패턴으로 알아보는 16가지 연애 회복 유형",
    icon: Heart,
    href: "/tests/breakup-recovery-speed",
    color: "from-fuchsia-500 via-rose-500 to-pink-500",
    participants: "0",
    rating: 5.0,
    badge: "NEW",
    category: "연애",
    tags: ["연애", "이별", "회복", "MBTI"],
    new: true,
    publishAt: "2026-05-19T15:00:00Z",
  },
  {
    id: "goal-persistence",
    title: "🎯 목표 지속력 테스트",
    description: "목표 추진력과 지속력으로 알아보는 16가지 자기계발 유형",
    icon: Trophy,
    href: "/tests/goal-persistence",
    color: "from-green-500 via-emerald-500 to-teal-500",
    participants: "0",
    rating: 5.0,
    badge: "NEW",
    category: "자기계발",
    tags: ["자기계발", "목표", "동기부여", "MBTI"],
    new: true,
    publishAt: "2026-05-21T15:00:00Z",
  },
  {
    id: "reading-focus",
    title: "📚 독서 집중도 유형 테스트",
    description: "독서 패턴과 집중 방식으로 알아보는 16가지 독서 유형",
    icon: BookOpen,
    href: "/tests/reading-focus",
    color: "from-amber-500 via-orange-500 to-yellow-500",
    participants: "0",
    rating: 5.0,
    badge: "NEW",
    category: "자기계발",
    tags: ["자기계발", "독서", "집중", "MBTI"],
    new: true,
    publishAt: "2026-05-23T15:00:00Z",
  },
  {
    id: "course-completion",
    title: "🎓 온라인 강의 완주율 테스트",
    description: "온라인 강의 학습 패턴으로 알아보는 16가지 학습 유형",
    icon: PencilRuler,
    href: "/tests/course-completion",
    color: "from-blue-500 via-cyan-500 to-sky-500",
    participants: "0",
    rating: 5.0,
    badge: "NEW",
    category: "자기계발",
    tags: ["자기계발", "온라인 강의", "학습", "MBTI"],
    new: true,
    publishAt: "2026-05-25T15:00:00Z",
  },
  {
    id: "language-learner-type",
    title: "🌐 외국어 학습 스타일 테스트",
    description: "외국어 학습 방식으로 알아보는 16가지 어학 유형",
    icon: Sparkles,
    href: "/tests/language-learner-type",
    color: "from-purple-500 via-pink-500 to-fuchsia-500",
    participants: "0",
    rating: 5.0,
    badge: "NEW",
    category: "자기계발",
    tags: ["자기계발", "외국어", "학습", "MBTI"],
    new: true,
    publishAt: "2026-05-27T15:00:00Z",
  },
  {
    id: "commute-style",
    title: "🚇 출퇴근 스타일 테스트",
